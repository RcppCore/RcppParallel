...
namespace boost { namespace simd
{
   ...
   **/
    struct split_ : ext::elementwise_<split_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_split_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
   template<class Site, class... Ts>
   BOOST_FORCEINLINE generic_dispatcher<tag::split_, Site> dispatching_split_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::split_, Site>();
   }
   template<class... Args>
   struct impl_split_;
  }

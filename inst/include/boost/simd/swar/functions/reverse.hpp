...
namespace boost { namespace simd { namespace tag
   ...
   **/
    struct reverse_ : ext::unspecified_<reverse_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_reverse_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
   template<class Site, class... Ts>
   BOOST_FORCEINLINE generic_dispatcher<tag::reverse_, Site> dispatching_reverse_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::reverse_, Site>();
   }
   template<class... Args>
   struct impl_reverse_;
  }
  /*!

...
namespace boost { namespace simd { namespace tag
   ...
   **/
    struct groups_ : ext::elementwise_<groups_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_groups_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
   template<class Site, class... Ts>
   BOOST_FORCEINLINE generic_dispatcher<tag::groups_, Site> dispatching_groups_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::groups_, Site>();
   }
   template<class... Args>
   struct impl_groups_;
  }

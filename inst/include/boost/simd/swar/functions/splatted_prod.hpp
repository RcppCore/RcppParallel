  ...
  namespace tag
  {
    ...
    **/
    struct splatted_prod_ : ext::unspecified_<splatted_prod_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_splatted_prod_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
    template<class Site, class... Ts>
    BOOST_FORCEINLINE generic_dispatcher<tag::splatted_prod_, Site> dispatching_splatted_prod_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
    {
      return generic_dispatcher<tag::splatted_prod_, Site>();
    }
    template<class... Args>
    struct impl_splatted_prod_;
  }

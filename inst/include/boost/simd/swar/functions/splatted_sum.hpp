  ...
  namespace tag
  {
    ...
    **/
    struct splatted_sum_ : ext::unspecified_<splatted_sum_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_splatted_sum_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
    template<class Site, class... Ts>
    BOOST_FORCEINLINE generic_dispatcher<tag::splatted_sum_, Site> dispatching_splatted_sum_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
    {
      return generic_dispatcher<tag::splatted_sum_, Site>();
    }
    template<class... Args>
    struct impl_splatted_sum_;
  }

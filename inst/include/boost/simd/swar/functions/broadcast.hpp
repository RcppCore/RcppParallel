...
namespace boost { namespace simd { namespace tag
  {
    ...
    **/
    struct broadcast_ : ext::unspecified_<broadcast_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_broadcast_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
    template<class Site, class... Ts>
    BOOST_FORCEINLINE generic_dispatcher<tag::broadcast_, Site> dispatching_broadcast_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
    {
      return generic_dispatcher<tag::broadcast_, Site>();
    }
    template<class... Args>
    struct impl_broadcast_;
  }

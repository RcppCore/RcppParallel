...
namespace boost { namespace simd { namespace tag
  {
    ...
    **/
    struct cumprod_ : ext::cumulative_<cumprod_, tag::multiplies_, tag::One>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_cumprod_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
    template<class Site, class... Ts>
    BOOST_FORCEINLINE generic_dispatcher<tag::cumprod_, Site> dispatching_cumprod_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
    {
      return generic_dispatcher<tag::cumprod_, Site>();
    }
    template<class... Args>
    struct impl_cumprod_;
  }
  /*!

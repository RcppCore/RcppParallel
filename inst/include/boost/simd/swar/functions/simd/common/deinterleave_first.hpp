...
//==============================================================================
#ifndef BOOST_SIMD_SWAR_FUNCTIONS_SIMD_COMMON_DEINTERLEAVE_FIRST_HPP_INCLUDED
#define BOOST_SIMD_SWAR_FUNCTIONS_SIMD_COMMON_DEINTERLEAVE_FIRST_HPP_INCLUDED
...
{
  BOOST_DISPATCH_IMPLEMENT          ( deinterleave_first_, tag::cpu_
                                    , (A0)(A1)(X)
  ...
  BOOST_DISPATCH_IMPLEMENT_IF         ( deinterleave_first_, tag::cpu_
                                      , (A0)(X)

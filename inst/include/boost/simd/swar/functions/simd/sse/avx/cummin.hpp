...
//==============================================================================
#ifndef BOOST_SIMD_SWAR_FUNCTIONS_SIMD_SSE_AVX_CUMMIN_HPP_INCLUDED
#define BOOST_SIMD_SWAR_FUNCTIONS_SIMD_SSE_AVX_CUMMIN_HPP_INCLUDED
...
{
  BOOST_DISPATCH_IMPLEMENT (cummin_, boost::simd::tag::avx_,
                            (A0),
...
/////////////////////////////////////////////////////////////////////////////
                                   ...
                                   )
  {
    ...
    BOOST_SIMD_FUNCTOR_CALL_REPEAT(1)
    {
      ...
      return _mm256_insertf128_pd(that, min(a01, z), 1);
    }
  };
...
/////////////////////////////////////////////////////////////////////////////
                                   ...
                                   )
  {
    ...
    BOOST_SIMD_FUNCTOR_CALL_REPEAT(1)
    {
      ...
      return _mm256_insertf128_ps(that, min(a01, z), 1);
    }
  };
} } }
#endif

...
//==============================================================================
#ifndef BOOST_SIMD_SWAR_FUNCTIONS_SIMD_VMX_ALTIVEC_SPLIT_HIGH_HPP_INCLUDED
#define BOOST_SIMD_SWAR_FUNCTIONS_SIMD_VMX_ALTIVEC_SPLIT_HIGH_HPP_INCLUDED
...
{
  BOOST_DISPATCH_IMPLEMENT          ( split_high_
                                    , boost::simd::tag::vmx_
                                    , (A0)
                                    , ((simd_ < int8_<A0>
                                              , boost::simd::tag::vmx_

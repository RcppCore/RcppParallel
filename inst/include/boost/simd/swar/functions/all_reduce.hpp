  ...
  namespace tag
  {
    ...
    **/
    struct all_reduce_ : ext::unspecified_<all_reduce_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_all_reduce_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
    template<class Site, class... Ts>
    BOOST_FORCEINLINE generic_dispatcher<tag::all_reduce_, Site> dispatching_all_reduce_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
    {
      return generic_dispatcher<tag::all_reduce_, Site>();
    }
    template<class... Args>
    struct impl_all_reduce_;
  }

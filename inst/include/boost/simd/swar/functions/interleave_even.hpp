...
namespace boost { namespace simd {
   ...
   **/
    struct interleave_even_ : ext::unspecified_<interleave_even_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_interleave_even_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
   template<class Site, class... Ts>
   BOOST_FORCEINLINE generic_dispatcher<tag::interleave_even_, Site> dispatching_interleave_even_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::interleave_even_, Site>();
   }
   template<class... Args>
   struct impl_interleave_even_;
  }

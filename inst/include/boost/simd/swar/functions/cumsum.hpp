...
namespace boost { namespace simd { namespace tag
  {
    ...
    **/
    struct cumsum_ : ext::cumulative_<cumsum_, tag::plus_, tag::Zero>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_cumsum_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
    template<class Site, class... Ts>
    BOOST_FORCEINLINE generic_dispatcher<tag::cumsum_, Site> dispatching_cumsum_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
    {
      return generic_dispatcher<tag::cumsum_, Site>();
    }
    template<class... Args>
    struct impl_cumsum_;
  }

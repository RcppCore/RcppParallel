...
namespace boost { namespace simd { namespace tag
   ...
   **/
    struct if_zero_else_ : ext::elementwise_<if_zero_else_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_if_zero_else_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
   template<class Site, class... Ts>
   BOOST_FORCEINLINE generic_dispatcher<tag::if_zero_else_, Site> dispatching_if_zero_else_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::if_zero_else_, Site>();
   }
   template<class... Args>
   struct impl_if_zero_else_;
  }
  /*!

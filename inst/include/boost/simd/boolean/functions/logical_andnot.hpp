...
namespace boost { namespace simd
{
   ...
   **/
    struct logical_andnot_ : ext::elementwise_<logical_andnot_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_logical_andnot_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
   template<class Site, class... Ts>
   BOOST_FORCEINLINE generic_dispatcher<tag::logical_andnot_, Site> dispatching_logical_andnot_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::logical_andnot_, Site>();
   }
   template<class... Args>
   struct impl_logical_andnot_;
  }
  /*!

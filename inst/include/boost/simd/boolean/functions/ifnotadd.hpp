...
namespace boost { namespace simd { namespace tag
   ...
   **/
    struct ifnotadd_ : ext::elementwise_<ifnotadd_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_ifnotadd_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
   template<class Site, class... Ts>
   BOOST_FORCEINLINE generic_dispatcher<tag::ifnotadd_, Site> dispatching_ifnotadd_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::ifnotadd_, Site>();
   }
   template<class... Args>
   struct impl_ifnotadd_;
  }
  /*!

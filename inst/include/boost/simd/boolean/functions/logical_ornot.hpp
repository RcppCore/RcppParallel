...
namespace boost { namespace simd
{
   ...
   **/
    struct logical_ornot_ : ext::elementwise_<logical_ornot_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_logical_ornot_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
   template<class Site, class... Ts>
   BOOST_FORCEINLINE generic_dispatcher<tag::logical_ornot_, Site> dispatching_logical_ornot_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::logical_ornot_, Site>();
   }
   template<class... Args>
   struct impl_logical_ornot_;
  }
  /*!

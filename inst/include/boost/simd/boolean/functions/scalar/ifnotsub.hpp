...
//==============================================================================
#ifndef BOOST_SIMD_BOOLEAN_FUNCTIONS_SCALAR_IFNOTSUB_HPP_INCLUDED
#define BOOST_SIMD_BOOLEAN_FUNCTIONS_SCALAR_IFNOTSUB_HPP_INCLUDED
...
{
  BOOST_DISPATCH_IMPLEMENT          ( ifnotsub_, tag::cpu_, (A0)(A1)

...
namespace boost { namespace simd { namespace tag
   ...
   **/
    struct if_else_zero_ : ext::elementwise_<if_else_zero_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_if_else_zero_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
   template<class Site, class... Ts>
   BOOST_FORCEINLINE generic_dispatcher<tag::if_else_zero_, Site> dispatching_if_else_zero_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::if_else_zero_, Site>();
   }
   template<class... Args>
   struct impl_if_else_zero_;
  }
  /*!

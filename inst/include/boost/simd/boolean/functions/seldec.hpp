...
namespace boost { namespace simd {
   ...
   **/
    struct seldec_ : ext::elementwise_<seldec_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_seldec_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
   template<class Site, class... Ts>
   BOOST_FORCEINLINE generic_dispatcher<tag::seldec_, Site> dispatching_seldec_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::seldec_, Site>();
   }
   template<class... Args>
   struct impl_seldec_;
  }

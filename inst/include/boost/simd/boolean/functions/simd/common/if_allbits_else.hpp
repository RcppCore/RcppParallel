...
//==============================================================================
#ifndef BOOST_SIMD_BOOLEAN_FUNCTIONS_SIMD_COMMON_IF_ALLBITS_ELSE_HPP_INCLUDED
#define BOOST_SIMD_BOOLEAN_FUNCTIONS_SIMD_COMMON_IF_ALLBITS_ELSE_HPP_INCLUDED
...
{
  BOOST_DISPATCH_IMPLEMENT_IF          ( if_allbits_else_, tag::cpu_, (A0)(A1)(X)

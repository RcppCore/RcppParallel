...
namespace boost { namespace simd { namespace tag
   ...
   **/
    struct is_even_ : ext::elementwise_<is_even_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_is_even_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };}
  namespace ext
  {
   template<class Site, class... Ts>
   BOOST_FORCEINLINE generic_dispatcher<tag::is_even_, Site> dispatching_is_even_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::is_even_, Site>();
   }
   template<class... Args>
   struct impl_is_even_;
  }
  /*!

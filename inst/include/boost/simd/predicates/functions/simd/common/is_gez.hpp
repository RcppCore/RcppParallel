...
//==============================================================================
#ifndef BOOST_SIMD_PREDICATES_FUNCTIONS_SIMD_COMMON_IS_GEZ_HPP_INCLUDED
#define BOOST_SIMD_PREDICATES_FUNCTIONS_SIMD_COMMON_IS_GEZ_HPP_INCLUDED
...
{
  BOOST_DISPATCH_IMPLEMENT         ( is_gez_, tag::cpu_
                            , (A0)(X)

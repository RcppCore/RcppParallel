...
//==============================================================================
#ifndef BOOST_SIMD_PREDICATES_FUNCTIONS_SCALAR_IS_NLEZ_HPP_INCLUDED
#define BOOST_SIMD_PREDICATES_FUNCTIONS_SCALAR_IS_NLEZ_HPP_INCLUDED
...
{
  BOOST_DISPATCH_IMPLEMENT( is_nlez_, tag::cpu_
                            , (A0)
                            , (scalar_< bool_<A0> >)
                            )
  {

...
namespace boost { namespace simd { namespace tag
   ...
   **/
    struct is_odd_ : ext::elementwise_<is_odd_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_is_odd_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };}
  namespace ext
  {
   template<class Site, class... Ts>
   BOOST_FORCEINLINE generic_dispatcher<tag::is_odd_, Site> dispatching_is_odd_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::is_odd_, Site>();
   }
   template<class... Args>
   struct impl_is_odd_;
  }

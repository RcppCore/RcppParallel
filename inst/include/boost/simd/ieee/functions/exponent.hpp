...
namespace boost { namespace simd { namespace tag
   ...
   **/
    struct exponent_ : ext::elementwise_<exponent_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_exponent_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
   template<class Site, class... Ts>
   BOOST_FORCEINLINE generic_dispatcher<tag::exponent_, Site> dispatching_exponent_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::exponent_, Site>();
   }
   template<class... Args>
   struct impl_exponent_;
  }
  /*!

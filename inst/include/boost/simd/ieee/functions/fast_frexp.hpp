...
namespace boost { namespace simd { namespace tag
   ...
   **/
    struct fast_frexp_ : ext::elementwise_<fast_frexp_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_fast_frexp_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
   template<class Site, class... Ts>
   BOOST_FORCEINLINE generic_dispatcher<tag::fast_frexp_, Site> dispatching_fast_frexp_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::fast_frexp_, Site>();
   }
   template<class... Args>
   struct impl_fast_frexp_;
  }

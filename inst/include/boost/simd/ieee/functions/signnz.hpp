...
namespace boost { namespace simd { namespace tag
   ...
   **/
    struct signnz_ : ext::elementwise_<signnz_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_signnz_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
   template<class Site, class... Ts>
   BOOST_FORCEINLINE generic_dispatcher<tag::signnz_, Site> dispatching_signnz_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::signnz_, Site>();
   }
   template<class... Args>
   struct impl_signnz_;
  }

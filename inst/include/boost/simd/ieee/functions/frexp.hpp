...
namespace boost { namespace simd
{
  namespace tag
  {
    ...
    struct frexp_ : ext::elementwise_<frexp_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_frexp_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
    template<class Site, class... Ts>
    BOOST_FORCEINLINE generic_dispatcher<tag::frexp_, Site> dispatching_frexp_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
    {
      return generic_dispatcher<tag::frexp_, Site>();
    }
    template<class... Args>
    struct impl_frexp_;
  }

...
namespace boost { namespace simd { namespace tag
   ...
   **/
    struct minmag_ : ext::elementwise_<minmag_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_minmag_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
   template<class Site, class... Ts>
   BOOST_FORCEINLINE generic_dispatcher<tag::minmag_, Site> dispatching_minmag_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::minmag_, Site>();
   }
   template<class... Args>
   struct impl_minmag_;
  }

...
namespace boost { namespace simd { namespace tag
   ...
   **/
    struct sign_ : ext::elementwise_<sign_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_sign_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
   template<class Site, class... Ts>
   BOOST_FORCEINLINE generic_dispatcher<tag::sign_, Site> dispatching_sign_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::sign_, Site>();
   }
   template<class... Args>
   struct impl_sign_;
  }

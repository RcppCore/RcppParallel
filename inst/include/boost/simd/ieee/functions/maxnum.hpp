...
namespace boost { namespace simd { namespace tag
   ...
   **/
    struct maxnum_ : ext::elementwise_<maxnum_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_maxnum_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
   template<class Site, class... Ts>
   BOOST_FORCEINLINE generic_dispatcher<tag::maxnum_, Site> dispatching_maxnum_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::maxnum_, Site>();
   }
   template<class... Args>
   struct impl_maxnum_;
  }

...
namespace boost { namespace simd { namespace tag
   ...
   **/
    struct bitfloating_ : ext::elementwise_<bitfloating_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_bitfloating_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
   template<class Site, class... Ts>
   BOOST_FORCEINLINE generic_dispatcher<tag::bitfloating_, Site> dispatching_bitfloating_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::bitfloating_, Site>();
   }
   template<class... Args>
   struct impl_bitfloating_;
  }
  /*!

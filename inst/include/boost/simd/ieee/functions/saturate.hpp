  ...
  namespace tag
  {
    ...
    **/
    struct saturate_ : ext::elementwise_<saturate_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_saturate_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
    template<class Site, class... Ts>
    BOOST_FORCEINLINE generic_dispatcher<tag::saturate_, Site> dispatching_saturate_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
    {
      return generic_dispatcher<tag::saturate_, Site>();
    }
    template<class... Args>
    struct impl_saturate_;
  }

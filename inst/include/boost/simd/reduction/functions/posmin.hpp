...
namespace boost { namespace simd { namespace tag
   ...
   **/
    struct posmin_ : ext::unspecified_<posmin_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_posmin_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
   template<class Site, class... Ts>
   BOOST_FORCEINLINE generic_dispatcher<tag::posmin_, Site> dispatching_posmin_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::posmin_, Site>();
   }
   template<class... Args>
   struct impl_posmin_;
  }

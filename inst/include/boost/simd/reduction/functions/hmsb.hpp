...
namespace boost { namespace simd { namespace tag
   ...
   **/
    ...
    struct hmsb_ : ext::unspecified_<hmsb_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_hmsb_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
   template<class Site, class... Ts>
   BOOST_FORCEINLINE generic_dispatcher<tag::hmsb_, Site> dispatching_hmsb_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::hmsb_, Site>();
   }
   template<class... Args>
   struct impl_hmsb_;
  }

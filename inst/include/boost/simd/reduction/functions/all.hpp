...
namespace boost { namespace simd
{
   ...
   **/
    ...
    struct all_ : ext::reduction_<all_, tag::logical_and_, tag::True>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_all_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
   template<class Site, class... Ts>
   BOOST_FORCEINLINE generic_dispatcher<tag::all_, Site> dispatching_all_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::all_, Site>();
   }
   template<class... Args>
   struct impl_all_;
  }

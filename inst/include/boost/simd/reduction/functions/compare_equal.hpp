...
namespace boost { namespace simd
{
   ...
   **/
    struct compare_equal_ : ext::unspecified_<compare_equal_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_compare_equal_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
   template<class Site, class... Ts>
   BOOST_FORCEINLINE generic_dispatcher<tag::compare_equal_, Site> dispatching_compare_equal_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::compare_equal_, Site>();
   }
   template<class... Args>
   struct impl_compare_equal_;
  }
  /*!

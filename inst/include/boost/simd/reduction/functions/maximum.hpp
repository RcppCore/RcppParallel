...
namespace boost { namespace simd
{
   ...
   **/
    ...
    struct maximum_ : ext::reduction_<maximum_, tag::max_, tag::Maxinit>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_maximum_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
   template<class Site, class... Ts>
   BOOST_FORCEINLINE generic_dispatcher<tag::maximum_, Site> dispatching_maximum_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::maximum_, Site>();
   }
   template<class... Args>
   struct impl_maximum_;
  }
  /*!

...
namespace boost { namespace simd
{
   ...
   **/
    struct logical_and_ : ext::elementwise_<logical_and_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_logical_and_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
   template<class Site, class... Ts>
   BOOST_FORCEINLINE generic_dispatcher<tag::logical_and_, Site> dispatching_logical_and_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::logical_and_, Site>();
   }
   template<class... Args>
   struct impl_logical_and_;
  }
  /*!

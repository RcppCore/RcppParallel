...
//==============================================================================
#ifndef BOOST_SIMD_OPERATOR_FUNCTIONS_OPTIMIZE_BITWISE_AND_HPP_INCLUDED
#define BOOST_SIMD_OPERATOR_FUNCTIONS_OPTIMIZE_BITWISE_AND_HPP_INCLUDED
...
{
  BOOST_DISPATCH_IMPLEMENT         ( bitwise_and_, tag::formal_
                            , (D)(A0)(A1)
                            , (unspecified_<A0>)

...
namespace boost { namespace simd
{
   ...
   **/
    struct is_not_equal_ : ext::elementwise_<is_not_equal_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_is_not_equal_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
   template<class Site, class... Ts>
   BOOST_FORCEINLINE generic_dispatcher<tag::is_not_equal_, Site> dispatching_is_not_equal_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::is_not_equal_, Site>();
   }
   template<class... Args>
   struct impl_is_not_equal_;
  }
  /*!

...
namespace boost { namespace simd
{
   ...
   **/
    struct make_ : ext::elementwise_<make_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_make_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
   template<class Site, class... Ts>
   BOOST_FORCEINLINE generic_dispatcher<tag::make_, Site> dispatching_make_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::make_, Site>();
   }
   template<class... Args>
   struct impl_make_;
  }

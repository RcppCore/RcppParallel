...
namespace boost { namespace simd { namespace tag
  {
    ...
    **/
    struct fma_ : ext::elementwise_<fma_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_fma_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
    template<class Site, class... Ts>
    BOOST_FORCEINLINE generic_dispatcher<tag::fma_, Site> dispatching_fma_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
    {
      return generic_dispatcher<tag::fma_, Site>();
    }
    template<class... Args>
    struct impl_fma_;
  }

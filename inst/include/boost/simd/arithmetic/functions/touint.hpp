...
namespace boost { namespace simd { namespace tag
  {
    ...
    **/
    struct touint_ : ext::elementwise_<touint_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_touint_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
    template<class Site, class... Ts>
    BOOST_FORCEINLINE generic_dispatcher<tag::touint_, Site> dispatching_touint_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
    {
      return generic_dispatcher<tag::touint_, Site>();
    }
    template<class... Args>
    struct impl_touint_;
  }

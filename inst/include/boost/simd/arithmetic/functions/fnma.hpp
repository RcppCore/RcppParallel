...
namespace boost { namespace simd { namespace tag
  {
    ...
    **/
    struct fnma_ : ext::elementwise_<fnma_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_fnma_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
    template<class Site, class... Ts>
    BOOST_FORCEINLINE generic_dispatcher<tag::fnma_, Site> dispatching_fnma_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
    {
      return generic_dispatcher<tag::fnma_, Site>();
    }
    template<class... Args>
    struct impl_fnma_;
  }

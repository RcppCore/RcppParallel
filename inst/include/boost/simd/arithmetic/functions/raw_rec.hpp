  ...
  namespace tag
  {
    ...
    **/
    struct raw_rec_ : ext::elementwise_<raw_rec_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_raw_rec_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
    template<class Site, class... Ts>
    BOOST_FORCEINLINE generic_dispatcher<tag::raw_rec_, Site> dispatching_raw_rec_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
    {
      return generic_dispatcher<tag::raw_rec_, Site>();
    }
    template<class... Args>
    struct impl_raw_rec_;
  }
  /*!

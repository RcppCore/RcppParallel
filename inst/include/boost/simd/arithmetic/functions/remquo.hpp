  ...
  namespace tag
  {
    ...
    **/
    struct remquo_ : ext::elementwise_<remquo_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_remquo_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
   template<class Site, class... Ts>
   BOOST_FORCEINLINE generic_dispatcher<tag::remquo_, Site> dispatching_remquo_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::remquo_, Site>();
   }
   template<class... Args>
   struct impl_remquo_;
  }

  ...
  namespace tag
  {
    ...
    **/
    struct adds_ : ext::elementwise_<adds_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_adds_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
    template<class Site, class... Ts>
    BOOST_FORCEINLINE generic_dispatcher<tag::adds_, Site> dispatching_adds_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
    {
      return generic_dispatcher<tag::adds_, Site>();
    }
    template<class... Args>
    struct impl_adds_;
  }

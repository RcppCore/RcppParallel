    ...
    **/
    struct correct_fma_ : ext::elementwise_<correct_fma_>
    {
     ...
     typedef ext::elementwise_<correct_fma_> parent;
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_correct_fma_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
    template<class Site, class... Ts>
    BOOST_FORCEINLINE generic_dispatcher<tag::correct_fma_, Site> dispatching_correct_fma_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
    {
      return generic_dispatcher<tag::correct_fma_, Site>();
    }
    template<class... Args>
    struct impl_correct_fma_;
  }
  /*!

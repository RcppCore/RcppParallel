  ...
  namespace tag
  {
    ...
    **/
    struct idivceil_ : ext::elementwise_<idivceil_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_idivceil_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
    template<class Site, class... Ts>
    BOOST_FORCEINLINE generic_dispatcher<tag::idivceil_, Site> dispatching_idivceil_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
    {
      return generic_dispatcher<tag::idivceil_, Site>();
    }
    template<class... Args>
    struct impl_idivceil_;
  }
  /*!

  ...
  namespace tag
  {
    ...
    **/
    struct idivfloor_ : ext::elementwise_<idivfloor_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_idivfloor_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
    template<class Site, class... Ts>
    BOOST_FORCEINLINE generic_dispatcher<tag::idivfloor_, Site> dispatching_idivfloor_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
    {
      return generic_dispatcher<tag::idivfloor_, Site>();
    }
    template<class... Args>
    struct impl_idivfloor_;
  }
  /*!

...
namespace boost { namespace simd { namespace tag
  {
    ...
    **/
    struct touints_ : ext::elementwise_<touints_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_touints_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
    template<class Site, class... Ts>
    BOOST_FORCEINLINE generic_dispatcher<tag::touints_, Site> dispatching_touints_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
    {
      return generic_dispatcher<tag::touints_, Site>();
    }
    template<class... Args>
    struct impl_touints_;
  }
  /*!

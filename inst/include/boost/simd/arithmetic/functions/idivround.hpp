...
namespace boost { namespace simd { namespace tag
  {
    ...
    **/
    struct idivround_ : ext::elementwise_<idivround_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_idivround_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
    template<class Site, class... Ts>
    BOOST_FORCEINLINE generic_dispatcher<tag::idivround_, Site> dispatching_idivround_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
    {
      return generic_dispatcher<tag::idivround_, Site>();
    }
    template<class... Args>
    struct impl_idivround_;
  }
  /*!

...
namespace boost { namespace simd { namespace tag
  {
    ...
    **/
    struct fms_ : ext::elementwise_<fms_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_fms_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
    template<class Site, class... Ts>
    BOOST_FORCEINLINE generic_dispatcher<tag::fms_, Site> dispatching_fms_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
    {
      return generic_dispatcher<tag::fms_, Site>();
    }
    template<class... Args>
    struct impl_fms_;
  }

  ...
  namespace tag
  {
    ...
    **/
    struct arg_ : ext::elementwise_<arg_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_arg_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
    template<class Site, class... Ts>
    BOOST_FORCEINLINE generic_dispatcher<tag::arg_, Site> dispatching_arg_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
    {
      return generic_dispatcher<tag::arg_, Site>();
    }
    template<class... Args>
    struct impl_arg_;
  }

  ...
  /*!
    ...
    **/
    struct oneplus_ : ext::elementwise_<oneplus_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_oneplus_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
  template<class Site, class... Ts>
  BOOST_FORCEINLINE generic_dispatcher<tag::oneplus_, Site> dispatching_oneplus_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
  {
    return generic_dispatcher<tag::oneplus_, Site>();
  }
  template<class... Args>
  struct impl_oneplus_;
  }
  /*!

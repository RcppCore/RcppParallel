  ...
  namespace tag
  {
    ...
    **/
    struct divround2even_ : ext::elementwise_<divround2even_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_divround2even_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
    template<class Site, class... Ts>
    BOOST_FORCEINLINE generic_dispatcher<tag::divround2even_, Site> dispatching_divround2even_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
    {
      return generic_dispatcher<tag::divround2even_, Site>();
    }
    template<class... Args>
    struct impl_divround2even_;
  }
  /*!

  ...
  namespace tag
  {
    ...
    **/
    struct abs_ : ext::elementwise_<abs_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_abs_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
    template<class Site, class... Ts>
    BOOST_FORCEINLINE generic_dispatcher<tag::abs_, Site> dispatching_abs_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
    {
      return generic_dispatcher<tag::abs_, Site>();
    }
    template<class... Args>
    struct impl_abs_;
  }

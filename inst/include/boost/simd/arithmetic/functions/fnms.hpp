...
namespace boost { namespace simd { namespace tag
  {
    ...
    **/
    struct fnms_ : ext::elementwise_<fnms_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_fnms_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
    template<class Site, class... Ts>
    BOOST_FORCEINLINE generic_dispatcher<tag::fnms_, Site> dispatching_fnms_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
    {
      return generic_dispatcher<tag::fnms_, Site>();
    }
    template<class... Args>
    struct impl_fnms_;
  }

  ...
  namespace tag
  {
    ...
    **/
    struct divround_ : ext::elementwise_<divround_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_divround_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
    template<class Site, class... Ts>
    BOOST_FORCEINLINE generic_dispatcher<tag::divround_, Site> dispatching_divround_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
    {
      return generic_dispatcher<tag::divround_, Site>();
    }
    template<class... Args>
    struct impl_divround_;
  }
  /*!

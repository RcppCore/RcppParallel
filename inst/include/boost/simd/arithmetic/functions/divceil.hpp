  ...
  namespace tag
  {
    ...
    **/
    struct divceil_ : ext::elementwise_<divceil_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_divceil_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
    template<class Site, class... Ts>
    BOOST_FORCEINLINE generic_dispatcher<tag::divceil_, Site> dispatching_divceil_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
    {
      return generic_dispatcher<tag::divceil_, Site>();
    }
    template<class... Args>
    struct impl_divceil_;
  }
  /*!

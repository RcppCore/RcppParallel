  ...
  namespace tag
  {
    ...
    **/
    struct fast_sqrt_ : ext::elementwise_<fast_sqrt_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_fast_sqrt_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
    template<class Site, class... Ts>
    BOOST_FORCEINLINE generic_dispatcher<tag::fast_sqrt_, Site> dispatching_fast_sqrt_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
    {
      return generic_dispatcher<tag::fast_sqrt_, Site>();
    }
    template<class... Args>
    struct impl_fast_sqrt_;
  }
 /*!

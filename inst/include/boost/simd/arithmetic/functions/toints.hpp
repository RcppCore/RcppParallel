...
namespace boost { namespace simd { namespace tag
  {
    ...
    **/
    struct toints_ : ext::elementwise_<toints_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_toints_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
    template<class Site, class... Ts>
    BOOST_FORCEINLINE generic_dispatcher<tag::toints_, Site> dispatching_toints_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
    {
      return generic_dispatcher<tag::toints_, Site>();
    }
    template<class... Args>
    struct impl_toints_;
  }

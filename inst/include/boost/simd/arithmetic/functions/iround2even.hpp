...
namespace boost { namespace simd { namespace tag
  {
    ...
    **/
    struct iround2even_ : ext::elementwise_<iround2even_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_iround2even_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
   template<class Site, class... Ts>
   BOOST_FORCEINLINE generic_dispatcher<tag::iround2even_, Site> dispatching_iround2even_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::iround2even_, Site>();
   }
   template<class... Args>
   struct impl_iround2even_;
  }
  /*!

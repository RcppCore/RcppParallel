...
namespace boost { namespace simd { namespace tag
  {
    ...
    **/
    struct dist_ : ext::elementwise_<dist_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_dist_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
    template<class Site, class... Ts>
    BOOST_FORCEINLINE generic_dispatcher<tag::dist_, Site> dispatching_dist_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
    {
      return generic_dispatcher<tag::dist_, Site>();
    }
    template<class... Args>
    struct impl_dist_;
  }

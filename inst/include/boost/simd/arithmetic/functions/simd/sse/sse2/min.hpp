...
//==============================================================================
#ifndef BOOST_SIMD_ARITHMETIC_FUNCTIONS_SIMD_SSE_SSE2_MIN_HPP_INCLUDED
#define BOOST_SIMD_ARITHMETIC_FUNCTIONS_SIMD_SSE_SSE2_MIN_HPP_INCLUDED
...
namespace boost { namespace simd { namespace ext
{
  ...
  BOOST_DISPATCH_IMPLEMENT          ( min_, boost::simd::tag::sse2_, (A0)
  ...
  BOOST_DISPATCH_IMPLEMENT          ( min_, boost::simd::tag::sse2_
                                    , (A0)

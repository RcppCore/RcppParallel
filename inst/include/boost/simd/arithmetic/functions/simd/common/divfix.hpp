...
//==============================================================================
#ifndef BOOST_SIMD_ARITHMETIC_FUNCTIONS_SIMD_COMMON_DIVFIX_HPP_INCLUDED
#define BOOST_SIMD_ARITHMETIC_FUNCTIONS_SIMD_COMMON_DIVFIX_HPP_INCLUDED
...
namespace boost { namespace simd { namespace ext
{
  ...
  BOOST_DISPATCH_IMPLEMENT          ( divfix_, tag::cpu_, (A0)(X)
                                    , ((simd_<ints8_<A0>,X>))
                                      ((simd_<ints8_<A0>,X>))
                                    )
  {

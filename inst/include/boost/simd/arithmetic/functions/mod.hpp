...
namespace boost { namespace simd { namespace tag
  {
    ...
    **/
    struct mod_ : ext::elementwise_<mod_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_mod_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
    template<class Site, class... Ts>
    BOOST_FORCEINLINE generic_dispatcher<tag::mod_, Site> dispatching_mod_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
    {
      return generic_dispatcher<tag::mod_, Site>();
    }
    template<class... Args>
    struct impl_mod_;
  }

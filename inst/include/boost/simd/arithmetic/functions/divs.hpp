  ...
  namespace tag
  {
    ...
    **/
    struct divs_ : ext::elementwise_<divs_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_divs_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
    template<class Site, class... Ts>
    BOOST_FORCEINLINE generic_dispatcher<tag::divs_, Site> dispatching_divs_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
    {
      return generic_dispatcher<tag::divs_, Site>();
    }
    template<class... Args>
    struct impl_divs_;
  }

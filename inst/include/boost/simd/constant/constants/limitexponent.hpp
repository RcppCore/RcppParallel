...
namespace boost { namespace simd
{
   ...
   **/
    struct Limitexponent : ext::pure_constant_<Limitexponent>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_Limitexponent( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  ...
  namespace ext
  {
   ...
   BOOST_FORCEINLINE generic_dispatcher<tag::Limitexponent, Site> dispatching_Limitexponent(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::Limitexponent, Site>();
   }
   template<class... Args>
   struct impl_Limitexponent;
  }
  /*!

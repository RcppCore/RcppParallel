...
namespace boost { namespace simd
{
  ...
  namespace ext
  {
   ...
   BOOST_FORCEINLINE generic_dispatcher<tag::Sqrt_2o_2, Site> dispatching_Sqrt_2o_2(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::Sqrt_2o_2, Site>();
   }
   template<class... Args>
   struct impl_Sqrt_2o_2;
  }

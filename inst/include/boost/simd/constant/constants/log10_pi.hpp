...
namespace boost { namespace simd
{
  ...
  namespace ext
  {
   ...
   BOOST_FORCEINLINE generic_dispatcher<tag::Log10_pi, Site> dispatching_Log10_pi(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::Log10_pi, Site>();
   }
   template<class... Args>
   struct impl_Log10_pi;
  }
  /*!

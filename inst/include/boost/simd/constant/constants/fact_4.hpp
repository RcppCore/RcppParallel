...
namespace boost { namespace simd
{
  ...
  namespace ext
  {
   ...
   BOOST_FORCEINLINE generic_dispatcher<tag::Fact_4, Site> dispatching_Fact_4(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::Fact_4, Site>();
   }
   template<class... Args>
   struct impl_Fact_4;
  }

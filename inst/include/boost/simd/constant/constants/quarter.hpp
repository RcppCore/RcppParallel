...
namespace boost { namespace simd
{
  ...
  namespace ext
  {
   ...
   BOOST_FORCEINLINE generic_dispatcher<tag::Quarter, Site> dispatching_Quarter(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::Quarter, Site>();
   }
   template<class... Args>
   struct impl_Quarter;
  }

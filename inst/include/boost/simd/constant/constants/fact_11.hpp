...
namespace boost { namespace simd
{
  ...
  namespace ext
  {
   ...
   BOOST_FORCEINLINE generic_dispatcher<tag::Fact_11, Site> dispatching_Fact_11(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::Fact_11, Site>();
   }
   template<class... Args>
   struct impl_Fact_11;
  }

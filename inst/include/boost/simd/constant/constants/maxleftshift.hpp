...
namespace boost { namespace simd
{
   ...
   **/
    struct Maxleftshift : ext::pure_constant_<Maxleftshift>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_Maxleftshift( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
   template<class Site, class... Ts>
   BOOST_FORCEINLINE generic_dispatcher<tag::Maxleftshift, Site> dispatching_Maxleftshift(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::Maxleftshift, Site>();
   }
   template<class... Args>
   struct impl_Maxleftshift;
  }
  /*!

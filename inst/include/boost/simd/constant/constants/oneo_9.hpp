...
namespace boost { namespace simd
{
  ...
  namespace ext
  {
   ...
   BOOST_FORCEINLINE generic_dispatcher<tag::Oneo_9, Site> dispatching_Oneo_9(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::Oneo_9, Site>();
   }
   template<class... Args>
   struct impl_Oneo_9;
  }

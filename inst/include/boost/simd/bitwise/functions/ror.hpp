...
namespace boost { namespace simd { namespace tag
  {
    ...
    **/
    struct ror_ : ext::elementwise_<ror_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_ror_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
    template<class Site, class... Ts>
    BOOST_FORCEINLINE generic_dispatcher<tag::ror_, Site> dispatching_ror_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
    {
      return generic_dispatcher<tag::ror_, Site>();
    }
    template<class... Args>
    struct impl_ror_;
  }

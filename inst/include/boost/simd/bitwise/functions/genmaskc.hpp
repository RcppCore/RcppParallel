...
namespace boost { namespace simd { namespace tag
  {
    ...
    **/
    struct genmaskc_ : ext::elementwise_<genmaskc_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_genmaskc_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
    template<class Site, class... Ts>
    BOOST_FORCEINLINE generic_dispatcher<tag::genmaskc_, Site> dispatching_genmaskc_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
    {
      return generic_dispatcher<tag::genmaskc_, Site>();
    }
    template<class... Args>
    struct impl_genmaskc_;
  }
  /*!

...
//==============================================================================
#ifndef BOOST_SIMD_BITWISE_FUNCTIONS_SIMD_COMMON_CTZ_HPP_INCLUDED
#define BOOST_SIMD_BITWISE_FUNCTIONS_SIMD_COMMON_CTZ_HPP_INCLUDED
...
{
  BOOST_DISPATCH_IMPLEMENT         ( ctz_, tag::cpu_
                            , (A0)(X)

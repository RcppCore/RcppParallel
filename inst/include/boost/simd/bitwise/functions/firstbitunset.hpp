...
namespace boost { namespace simd { namespace tag
  {
    ...
    **/
    struct firstbitunset_ : ext::elementwise_<firstbitunset_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_firstbitunset_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
    template<class Site, class... Ts>
    BOOST_FORCEINLINE generic_dispatcher<tag::firstbitunset_, Site> dispatching_firstbitunset_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
    {
      return generic_dispatcher<tag::firstbitunset_, Site>();
    }
    template<class... Args>
    struct impl_firstbitunset_;
  }
  /*!

...
namespace boost { namespace simd { namespace tag
  {
    ...
    **/
    struct ctz_ : ext::elementwise_<ctz_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_ctz_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
    template<class Site, class... Ts>
    BOOST_FORCEINLINE generic_dispatcher<tag::ctz_, Site> dispatching_ctz_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
    {
      return generic_dispatcher<tag::ctz_, Site>();
    }
    template<class... Args>
    struct impl_ctz_;
  }

...
namespace boost { namespace simd { namespace tag
  {
    ...
    **/
    struct shr_ : ext::elementwise_<shr_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_shr_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
    template<class Site, class... Ts>
    BOOST_FORCEINLINE generic_dispatcher<tag::shr_, Site> dispatching_shr_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
    {
      return generic_dispatcher<tag::shr_, Site>();
    }
    template<class... Args>
    struct impl_shr_;
  }

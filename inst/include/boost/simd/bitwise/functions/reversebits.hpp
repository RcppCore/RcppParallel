...
namespace boost { namespace simd { namespace tag
  {
    ...
    **/
    struct reversebits_ : ext::elementwise_<reversebits_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_reversebits_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
    template<class Site, class... Ts>
    BOOST_FORCEINLINE generic_dispatcher<tag::reversebits_, Site> dispatching_reversebits_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
    {
      return generic_dispatcher<tag::reversebits_, Site>();
    }
    template<class... Args>
    struct impl_reversebits_;
  }
  /*!

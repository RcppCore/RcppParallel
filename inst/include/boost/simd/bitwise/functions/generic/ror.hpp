...
//==============================================================================
#ifndef BOOST_SIMD_BITWISE_FUNCTIONS_GENERIC_ROR_HPP_INCLUDED
#define BOOST_SIMD_BITWISE_FUNCTIONS_GENERIC_ROR_HPP_INCLUDED
...
{
  BOOST_DISPATCH_IMPLEMENT_IF          ( ror_, tag::cpu_
                                       , (A0)(A1)
                                       , (boost::mpl::equal_to
                                       ...
                                       )
  {
    ...
    BOOST_FORCEINLINE result_type operator()(A0 const& a0, A0 const& a1) const
    {
      ...
      return shri(a0, a1) | shli(a0, (width-splat<A0>(a1)) & (width-1));
    }
  };

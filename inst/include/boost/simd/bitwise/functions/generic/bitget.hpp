...
//==============================================================================
#ifndef BOOST_SIMD_BITWISE_FUNCTIONS_GENERIC_BITGET_HPP_INCLUDED
#define BOOST_SIMD_BITWISE_FUNCTIONS_GENERIC_BITGET_HPP_INCLUDED

#include <boost/simd/bitwise/functions/bitget.hpp>
...
{
  BOOST_DISPATCH_IMPLEMENT_IF( bitget_, tag::cpu_
                             , (A0)(A1)
                             , (boost::mpl::equal_to
  ...
  {
    typedef typename boost::dispatch::meta::as_integer<A0, unsigned>::type result_type;
  ...
  BOOST_DISPATCH_IMPLEMENT( bitget_, tag::cpu_
                          , (A0)(A1)
                          , (generic_< arithmetic_<A0> >)
                            (scalar_< integer_<A1> >)
                          )

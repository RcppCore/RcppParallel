...
namespace boost { namespace simd { namespace tag
  {
    ...
    **/
    struct hi_ : ext::elementwise_<hi_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_hi_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
    template<class Site, class... Ts>
    BOOST_FORCEINLINE generic_dispatcher<tag::hi_, Site> dispatching_hi_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
    {
      return generic_dispatcher<tag::hi_, Site>();
    }
    template<class... Args>
    struct impl_hi_;
  }

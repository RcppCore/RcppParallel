...
namespace boost { namespace simd { namespace tag
  {
    ...
    **/
    struct bitwise_notor_ : ext::elementwise_<bitwise_notor_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_bitwise_notor_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
    template<class Site, class... Ts>
    BOOST_FORCEINLINE generic_dispatcher<tag::bitwise_notor_, Site> dispatching_bitwise_notor_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
    {
      return generic_dispatcher<tag::bitwise_notor_, Site>();
    }
    template<class... Args>
    struct impl_bitwise_notor_;
  }
  /*!

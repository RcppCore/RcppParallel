...
namespace boost { namespace simd { namespace tag
  {
    ...
    **/
    struct ilog2_ : ext::elementwise_<ilog2_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_ilog2_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
    template<class Site, class... Ts>
    BOOST_FORCEINLINE generic_dispatcher<tag::ilog2_, Site> dispatching_ilog2_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
    {
      return generic_dispatcher<tag::ilog2_, Site>();
    }
    template<class... Args>
    struct impl_ilog2_;
  }

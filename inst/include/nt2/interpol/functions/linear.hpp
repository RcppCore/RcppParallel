...
namespace nt2 { namespace tag
   ...
   **/
    struct linear_ : ext::unspecified_<linear_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_linear_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
   template<class Site, class... Ts>
   BOOST_FORCEINLINE generic_dispatcher<tag::linear_, Site> dispatching_linear_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::linear_, Site>();
   }
   template<class... Args>
   struct impl_linear_;
  }

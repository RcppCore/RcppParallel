...
namespace nt2 { namespace tag
   ...
   **/
    struct interp1_ : ext::unspecified_<interp1_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_interp1_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
   template<class Site, class... Ts>
   BOOST_FORCEINLINE generic_dispatcher<tag::interp1_, Site> dispatching_interp1_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::interp1_, Site>();
   }
   template<class... Args>
   struct impl_interp1_;
  }
  /*!

...
namespace nt2 { namespace tag
   ...
   **/
    struct idx_linear_ : ext::unspecified_<idx_linear_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_idx_linear_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
   template<class Site, class... Ts>
   BOOST_FORCEINLINE generic_dispatcher<tag::idx_linear_, Site> dispatching_idx_linear_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::idx_linear_, Site>();
   }
   template<class... Args>
   struct impl_idx_linear_;
  }
  /*!

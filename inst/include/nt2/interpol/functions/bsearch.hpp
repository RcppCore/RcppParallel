...
namespace nt2 { namespace tag
   ...
   **/
    struct bsearch_ : ext::unspecified_<bsearch_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_bsearch_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
   template<class Site, class... Ts>
   BOOST_FORCEINLINE generic_dispatcher<tag::bsearch_, Site> dispatching_bsearch_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::bsearch_, Site>();
   }
   template<class... Args>
   struct impl_bsearch_;
  }
  /*!

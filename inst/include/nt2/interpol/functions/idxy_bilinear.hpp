...
namespace nt2 { namespace tag
   ...
   **/
    struct idxy_bilinear_ : ext::unspecified_<idxy_bilinear_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_idxy_bilinear_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
   template<class Site, class... Ts>
   BOOST_FORCEINLINE generic_dispatcher<tag::idxy_bilinear_, Site> dispatching_idxy_bilinear_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::idxy_bilinear_, Site>();
   }
   template<class... Args>
   struct impl_idxy_bilinear_;
  }
  /*!

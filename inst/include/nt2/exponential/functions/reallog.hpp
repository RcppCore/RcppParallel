...
namespace nt2 { namespace tag
   ...
   **/
    struct reallog_ : ext::elementwise_<reallog_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_reallog_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
   template<class Site, class... Ts>
   BOOST_FORCEINLINE generic_dispatcher<tag::reallog_, Site> dispatching_reallog_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::reallog_, Site>();
   }
   template<class... Args>
   struct impl_reallog_;
  }
  /*!

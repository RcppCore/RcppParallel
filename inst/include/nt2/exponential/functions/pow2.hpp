...
namespace nt2 { namespace tag
   ...
   **/
    struct pow2_ : ext::elementwise_<pow2_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_pow2_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
   template<class Site, class... Ts>
   BOOST_FORCEINLINE generic_dispatcher<tag::pow2_, Site> dispatching_pow2_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::pow2_, Site>();
   }
   template<class... Args>
   struct impl_pow2_;
  }

...
namespace nt2 { namespace tag
   ...
   **/
    struct log10_ : ext::elementwise_<log10_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_log10_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
   template<class Site, class... Ts>
   BOOST_FORCEINLINE generic_dispatcher<tag::log10_, Site> dispatching_log10_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::log10_, Site>();
   }
   template<class... Args>
   struct impl_log10_;
  }

...
namespace nt2 { namespace tag
   ...
   **/
    struct log2_ : ext::elementwise_<log2_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_log2_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
   template<class Site, class... Ts>
   BOOST_FORCEINLINE generic_dispatcher<tag::log2_, Site> dispatching_log2_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::log2_, Site>();
   }
   template<class... Args>
   struct impl_log2_;
  }

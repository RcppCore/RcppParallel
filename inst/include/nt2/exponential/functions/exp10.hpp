...
namespace nt2 { namespace tag
   ...
   **/
    struct exp10_ : ext::elementwise_<exp10_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_exp10_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
   template<class Site, class... Ts>
   BOOST_FORCEINLINE generic_dispatcher<tag::exp10_, Site> dispatching_exp10_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::exp10_, Site>();
   }
   template<class... Args>
   struct impl_exp10_;
  }

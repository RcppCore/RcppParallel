...
namespace nt2 { namespace tag
   ...
   **/
    struct nthroot_ : ext::elementwise_<nthroot_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_nthroot_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
   template<class Site, class... Ts>
   BOOST_FORCEINLINE generic_dispatcher<tag::nthroot_, Site> dispatching_nthroot_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::nthroot_, Site>();
   }
   template<class... Args>
   struct impl_nthroot_;
  }
  /*!

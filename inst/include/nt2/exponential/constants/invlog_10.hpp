...
namespace nt2
{
  ...
  namespace ext
  {
    ...
    BOOST_FORCEINLINE generic_dispatcher<tag::Invlog_10, Site> dispatching_Invlog_10(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
    {
      return generic_dispatcher<tag::Invlog_10, Site>();
    }
    template<class... Args>
    struct impl_Invlog_10;
  }
  /*!

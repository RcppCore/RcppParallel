...
namespace nt2
{
  ...
  namespace ext
  {
    ...
    BOOST_FORCEINLINE generic_dispatcher<tag::Maxlog10, Site> dispatching_Maxlog10(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
    {
      return generic_dispatcher<tag::Maxlog10, Site>();
    }
    template<class... Args>
    struct impl_Maxlog10;
  }
  /*!

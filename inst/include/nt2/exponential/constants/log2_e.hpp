...
namespace nt2
{
  ...
  namespace ext
  {
    ...
    BOOST_FORCEINLINE generic_dispatcher<tag::Log2_e, Site> dispatching_Log2_e(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
    {
      return generic_dispatcher<tag::Log2_e, Site>();
    }
    template<class... Args>
    struct impl_Log2_e;
  }

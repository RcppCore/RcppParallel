...
namespace nt2
{
  ...
  namespace ext
  {
    ...
    BOOST_FORCEINLINE generic_dispatcher<tag::Minlog10, Site> dispatching_Minlog10(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
    {
      return generic_dispatcher<tag::Minlog10, Site>();
    }
    template<class... Args>
    struct impl_Minlog10;
  }
  /*!

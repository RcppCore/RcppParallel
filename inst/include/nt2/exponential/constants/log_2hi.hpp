...
namespace nt2
{
  ...
  namespace ext
  {
    ...
    BOOST_FORCEINLINE generic_dispatcher<tag::Log_2hi, Site> dispatching_Log_2hi(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
    {
      return generic_dispatcher<tag::Log_2hi, Site>();
    }
    template<class... Args>
    struct impl_Log_2hi;
  }

...
namespace nt2
{
  ...
  namespace ext
  {
    ...
    BOOST_FORCEINLINE generic_dispatcher<tag::Log10_ehi, Site> dispatching_Log10_ehi(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
    {
      return generic_dispatcher<tag::Log10_ehi, Site>();
    }
    template<class... Args>
    struct impl_Log10_ehi;
  }
 /*!

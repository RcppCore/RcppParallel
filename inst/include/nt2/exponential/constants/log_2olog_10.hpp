...
namespace nt2
{
  ...
  namespace ext
  {
    ...
    BOOST_FORCEINLINE generic_dispatcher<tag::Log_2olog_10, Site> dispatching_Log_2olog_10(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
    {
      return generic_dispatcher<tag::Log_2olog_10, Site>();
    }
    template<class... Args>
    struct impl_Log_2olog_10;
  }
  /*!

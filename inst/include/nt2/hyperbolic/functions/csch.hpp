...
namespace nt2 { namespace tag
   ...
   **/
    struct csch_ : ext::elementwise_<csch_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_csch_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
   template<class Site, class... Ts>
   BOOST_FORCEINLINE generic_dispatcher<tag::csch_, Site> dispatching_csch_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::csch_, Site>();
   }
   template<class... Args>
   struct impl_csch_;
  }

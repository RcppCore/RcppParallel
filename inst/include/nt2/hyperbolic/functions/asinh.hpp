...
namespace nt2 { namespace tag
   ...
   **/
    struct asinh_ : ext::elementwise_<asinh_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_asinh_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
   template<class Site, class... Ts>
   BOOST_FORCEINLINE generic_dispatcher<tag::asinh_, Site> dispatching_asinh_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::asinh_, Site>();
   }
   template<class... Args>
   struct impl_asinh_;
  }

...
namespace nt2 { namespace tag
   ...
   **/
    struct coth_ : ext::elementwise_<coth_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_coth_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
   template<class Site, class... Ts>
   BOOST_FORCEINLINE generic_dispatcher<tag::coth_, Site> dispatching_coth_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::coth_, Site>();
   }
   template<class... Args>
   struct impl_coth_;
  }

...
namespace nt2 { namespace tag
   ...
   **/
    struct sech_ : ext::elementwise_<sech_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_sech_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
   template<class Site, class... Ts>
   BOOST_FORCEINLINE generic_dispatcher<tag::sech_, Site> dispatching_sech_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::sech_, Site>();
   }
   template<class... Args>
   struct impl_sech_;
  }

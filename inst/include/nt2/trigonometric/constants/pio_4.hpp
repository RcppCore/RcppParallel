...
namespace nt2
{
  ...
  namespace ext
  {
   ...
   BOOST_FORCEINLINE generic_dispatcher<tag::Pio_4, Site> dispatching_Pio_4(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::Pio_4, Site>();
   }
   template<class... Args>
   struct impl_Pio_4;
  }

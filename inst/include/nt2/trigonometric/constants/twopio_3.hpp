...
namespace nt2
{
  ...
  namespace ext
  {
   ...
   BOOST_FORCEINLINE generic_dispatcher<tag::Twopio_3, Site> dispatching_Twopio_3(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::Twopio_3, Site>();
   }
   template<class... Args>
   struct impl_Twopio_3;
  }
  /*!

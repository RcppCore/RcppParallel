...
namespace nt2
{
  ...
  namespace ext
  {
   ...
   BOOST_FORCEINLINE generic_dispatcher<tag::Pix2_2, Site> dispatching_Pix2_2(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::Pix2_2, Site>();
   }
   template<class... Args>
   struct impl_Pix2_2;
  }

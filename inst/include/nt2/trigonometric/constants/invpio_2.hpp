...
namespace nt2
{
  ...
  namespace ext
  {
   ...
   BOOST_FORCEINLINE generic_dispatcher<tag::Invpio_2, Site> dispatching_Invpio_2(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {

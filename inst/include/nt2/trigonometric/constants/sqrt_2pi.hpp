...
namespace nt2
{
  ...
  namespace ext
  {
   ...
   BOOST_FORCEINLINE generic_dispatcher<tag::Sqrt_2pi, Site> dispatching_Sqrt_2pi(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::Sqrt_2pi, Site>();
   }
   template<class... Args>
   struct impl_Sqrt_2pi;
  }
  /*!

...
namespace nt2 { namespace tag
  {
    ...
    struct sincosd_ : ext::elementwise_<sincosd_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_sincosd_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
    template<class Site, class... Ts>
    BOOST_FORCEINLINE generic_dispatcher<tag::sincosd_, Site> dispatching_sincosd_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
    {
      return generic_dispatcher<tag::sincosd_, Site>();
    }
    template<class... Args>
    struct impl_sincosd_;
  }
  /*!

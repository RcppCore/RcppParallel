...
namespace nt2 { namespace tag
   ...
   **/
    struct tan_ : ext::elementwise_<tan_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_tan_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
   template<class Site, class... Ts>
   BOOST_FORCEINLINE generic_dispatcher<tag::tan_, Site> dispatching_tan_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::tan_, Site>();
   }
   template<class... Args>
   struct impl_tan_;
  }

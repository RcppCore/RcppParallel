...
namespace nt2 { namespace tag
   ...
   **/
    struct asec_ : ext::elementwise_<asec_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_asec_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
   template<class Site, class... Ts>
   BOOST_FORCEINLINE generic_dispatcher<tag::asec_, Site> dispatching_asec_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::asec_, Site>();
   }
   template<class... Args>
   struct impl_asec_;
  }

...
namespace nt2 { namespace tag
  {
    ...
    struct sincos_ : ext::elementwise_<sincos_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_sincos_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
    template<class Site, class... Ts>
    BOOST_FORCEINLINE generic_dispatcher<tag::sincos_, Site> dispatching_sincos_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
    {
      return generic_dispatcher<tag::sincos_, Site>();
    }
    template<class... Args>
    struct impl_sincos_;
  }

...
namespace nt2 { namespace tag
   ...
   **/
    struct fast_tand_ : ext::elementwise_<fast_tand_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_fast_tand_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
   template<class Site, class... Ts>
   BOOST_FORCEINLINE generic_dispatcher<tag::fast_tand_, Site> dispatching_fast_tand_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::fast_tand_, Site>();
   }
   template<class... Args>
   struct impl_fast_tand_;
  }
  /*!

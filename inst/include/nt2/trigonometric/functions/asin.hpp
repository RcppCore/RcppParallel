...
namespace nt2 { namespace tag
   ...
   **/
    struct asin_ : ext::elementwise_<asin_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_asin_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
   template<class Site, class... Ts>
   BOOST_FORCEINLINE generic_dispatcher<tag::asin_, Site> dispatching_asin_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::asin_, Site>();
   }
   template<class... Args>
   struct impl_asin_;
  }

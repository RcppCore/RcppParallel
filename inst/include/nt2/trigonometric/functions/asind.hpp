...
namespace nt2 { namespace tag
   ...
   **/
    struct asind_ : ext::elementwise_<asind_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_asind_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
   template<class Site, class... Ts>
   BOOST_FORCEINLINE generic_dispatcher<tag::asind_, Site> dispatching_asind_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::asind_, Site>();
   }
   template<class... Args>
   struct impl_asind_;
  }

...
namespace nt2 { namespace ext
{
  ...
  {
    typedef typename boost::dispatch::meta::terminal_of<A0>::type tof_t;
    typedef typename nt2::meta::as_integer<tof_t>::type result_type;

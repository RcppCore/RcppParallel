...
//==============================================================================
#ifndef NT2_TRIGONOMETRIC_FUNCTIONS_CONTAINER_REM_PIO2_MEDIUM_HPP_INCLUDED
#define NT2_TRIGONOMETRIC_FUNCTIONS_CONTAINER_REM_PIO2_MEDIUM_HPP_INCLUDED
...
{
  BOOST_DISPATCH_IMPLEMENT  ( rem_pio2_medium_, tag::cpu_
                            , (A0)(A1)(A2)
                            ...
                            )
  {
    ...
    {
      nt2::tie(r0,r1) = nt2::rem_pio2_medium(a0);
    }
  };

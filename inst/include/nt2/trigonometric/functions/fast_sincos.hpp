...
namespace nt2
{
   ...
   **/
    struct fast_sincos_ : ext::elementwise_<fast_sincos_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_fast_sincos_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
   template<class Site, class... Ts>
   BOOST_FORCEINLINE generic_dispatcher<tag::fast_sincos_, Site> dispatching_fast_sincos_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::fast_sincos_, Site>();
   }
   template<class... Args>
   struct impl_fast_sincos_;
  }
  /*!

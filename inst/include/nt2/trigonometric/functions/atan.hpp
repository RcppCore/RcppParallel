...
namespace nt2 { namespace tag
   ...
   **/
    struct atan_ : ext::elementwise_<atan_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_atan_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
   template<class Site, class... Ts>
   BOOST_FORCEINLINE generic_dispatcher<tag::atan_, Site> dispatching_atan_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::atan_, Site>();
   }
   template<class... Args>
   struct impl_atan_;
  }

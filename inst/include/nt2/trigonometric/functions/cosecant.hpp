...
namespace nt2 { namespace tag
   ...
   **/
    ...
    struct cosecant_ : ext::elementwise_< cosecant_<T> >
    {
      ...
      BOOST_AUTO_DECLTYPE_HEADER( dispatching( ext::adl_helper(), *(cosecant_*)0, static_cast<Args&&>(args)... ) )
      {
        return dispatching( ext::adl_helper(), cosecant_(), static_cast<Args&&>(args)... );
      }
    };
  }
  /*!

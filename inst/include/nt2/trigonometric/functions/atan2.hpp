...
namespace nt2 { namespace tag
   ...
   **/
    struct atan2_ : ext::elementwise_<atan2_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_atan2_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
   template<class Site, class... Ts>
   BOOST_FORCEINLINE generic_dispatcher<tag::atan2_, Site> dispatching_atan2_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::atan2_, Site>();
   }
   template<class... Args>
   struct impl_atan2_;
  }

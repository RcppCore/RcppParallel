...
namespace nt2 { namespace tag
   ...
   **/
    struct fast_tanpi_ : ext::elementwise_<fast_tanpi_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_fast_tanpi_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
   template<class Site, class... Ts>
   BOOST_FORCEINLINE generic_dispatcher<tag::fast_tanpi_, Site> dispatching_fast_tanpi_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::fast_tanpi_, Site>();
   }
   template<class... Args>
   struct impl_fast_tanpi_;
  }
  /*!

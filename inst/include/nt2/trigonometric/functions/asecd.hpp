...
namespace nt2 { namespace tag
   ...
   **/
    struct asecd_ : ext::elementwise_<asecd_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_asecd_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
   template<class Site, class... Ts>
   BOOST_FORCEINLINE generic_dispatcher<tag::asecd_, Site> dispatching_asecd_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::asecd_, Site>();
   }
   template<class... Args>
   struct impl_asecd_;
  }

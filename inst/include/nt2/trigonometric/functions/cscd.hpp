...
namespace nt2 { namespace tag
   ...
   **/
    struct cscd_ : ext::elementwise_<cscd_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_cscd_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
   template<class Site, class... Ts>
   BOOST_FORCEINLINE generic_dispatcher<tag::cscd_, Site> dispatching_cscd_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::cscd_, Site>();
   }
   template<class... Args>
   struct impl_cscd_;
  }

...
namespace nt2 { namespace tag
  {
    struct rem_pio2_medium_ : ext::elementwise_<rem_pio2_medium_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_rem_pio2_medium_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
    template<class Site, class... Ts>
    BOOST_FORCEINLINE generic_dispatcher<tag::rem_pio2_medium_, Site> dispatching_rem_pio2_medium_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
    {
      return generic_dispatcher<tag::rem_pio2_medium_, Site>();
    }
    template<class... Args>
    struct impl_rem_pio2_medium_;
  }
  /*!

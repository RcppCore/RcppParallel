...
//==============================================================================
#ifndef NT2_TRIGONOMETRIC_FUNCTIONS_GENERIC_FAST_SINCOSD_HPP_INCLUDED
#define NT2_TRIGONOMETRIC_FUNCTIONS_GENERIC_FAST_SINCOSD_HPP_INCLUDED
...
namespace nt2 { namespace ext
{
                            ...
                            )
  {
    ...
    {
      return details::trig_base <A0,degree_tag,is_native_t,clipped_pio4_>::sincosa(a0,a2);
    }
  };
                            ...
                            )
  {
    ...
    {
      A0 second;
      A0 const first = details::trig_base <A0,degree_tag,is_native_t,clipped_pio4_>::sincosa(a0,second);
                            ...
                            )
  {
    ...
    {
      a1 = details::trig_base <A0,degree_tag,is_native_t,clipped_pio4_>::sincosa(a0,a2);
    }
  };

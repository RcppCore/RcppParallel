...
//==============================================================================
#ifndef NT2_TRIGONOMETRIC_FUNCTIONS_GENERIC_TAN_HPP_INCLUDED
#define NT2_TRIGONOMETRIC_FUNCTIONS_GENERIC_TAN_HPP_INCLUDED
...
{
  BOOST_DISPATCH_IMPLEMENT  ( tan_, tag::cpu_
                            , (A0)
                            ...
                            )
  {
    ...
    NT2_FUNCTOR_CALL(1)
    {
      return details::trig_base<A0,radian_tag,is_native_t,big_>::tana(a0);
    }
  };
} }

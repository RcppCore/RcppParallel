...
//==============================================================================
#ifndef NT2_TRIGONOMETRIC_FUNCTIONS_GENERIC_SINCOSD_HPP_INCLUDED
#define NT2_TRIGONOMETRIC_FUNCTIONS_GENERIC_SINCOSD_HPP_INCLUDED
#include <nt2/trigonometric/functions/sincosd.hpp>
...
namespace nt2 { namespace ext
{
  ...
  BOOST_DISPATCH_IMPLEMENT  ( sincosd_
                            , tag::cpu_
                            , (A0)
  ...
  BOOST_DISPATCH_IMPLEMENT  ( sincosd_, tag::cpu_
                            , (A0)
                            , (generic_< floating_<A0> >)
                            )
  {
    ...
    {
      A0 second;
      A0 const first = details::trig_base <A0,degree_tag,is_native_t>::sincosa(a0,second);

...
//==============================================================================
#ifndef NT2_TRIGONOMETRIC_FUNCTIONS_GENERIC_SINECOSINE_HPP_INCLUDED
#define NT2_TRIGONOMETRIC_FUNCTIONS_GENERIC_SINECOSINE_HPP_INCLUDED
...
namespace nt2 { namespace ext
{
  ...
  BOOST_DISPATCH_IMPLEMENT_G( nt2::tag::sinecosine_<mode>
                            , tag::cpu_
                            , (A0)(mode)
                            ...
                            )
  {
    ...
    {
      return details::trig_base <A0,radian_tag,is_native_t,mode>::sincosa(a0,a2);
    }
  };
                            ...
                            )
  {
    ...
    {
      A0 second;
      A0 const first = details::trig_base <A0,radian_tag,is_native_t,mode>::sincosa(a0,second);
                            ...
                            )
  {
    ...
    {
      a1 = details::trig_base <A0,radian_tag,is_native_t,mode>::sincosa(a0,a2);
    }
  };

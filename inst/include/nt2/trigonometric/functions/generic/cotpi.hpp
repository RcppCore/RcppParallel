...
//==============================================================================
#ifndef NT2_TRIGONOMETRIC_FUNCTIONS_GENERIC_COTPI_HPP_INCLUDED
#define NT2_TRIGONOMETRIC_FUNCTIONS_GENERIC_COTPI_HPP_INCLUDED
#include <nt2/trigonometric/functions/cotpi.hpp>
...
namespace nt2 { namespace ext
{
                            ...
                            )
  {
    ...
    NT2_FUNCTOR_CALL(1)
    {
      return details::trig_base<A0,pi_tag,is_native_t>::cota(a0);
    }
  };
} }

...
//==============================================================================
#ifndef NT2_TRIGONOMETRIC_FUNCTIONS_GENERIC_TANPI_HPP_INCLUDED
#define NT2_TRIGONOMETRIC_FUNCTIONS_GENERIC_TANPI_HPP_INCLUDED
...
{
  BOOST_DISPATCH_IMPLEMENT  ( tanpi_, tag::cpu_
                            , (A0)
                            ...
                            )
  {
    ...
    NT2_FUNCTOR_CALL(1)
    {
      return details::trig_base<A0,pi_tag,is_native_t,big_>::tana(a0);
    }
  };
} }

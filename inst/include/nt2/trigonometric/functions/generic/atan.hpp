...
//==============================================================================
#ifndef NT2_TRIGONOMETRIC_FUNCTIONS_GENERIC_ATAN_HPP_INCLUDED
#define NT2_TRIGONOMETRIC_FUNCTIONS_GENERIC_ATAN_HPP_INCLUDED
...
namespace nt2 { namespace ext
{
                            ...
                            )
  {
    ...
    NT2_FUNCTOR_CALL(1)
    {
      return details::invtrig_base<A0,radian_tag,is_native_t>::atan(a0);
    }
  };
} }

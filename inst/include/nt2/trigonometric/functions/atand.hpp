...
namespace nt2 { namespace tag
   ...
   **/
    struct atand_ : ext::elementwise_<atand_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_atand_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
   template<class Site, class... Ts>
   BOOST_FORCEINLINE generic_dispatcher<tag::atand_, Site> dispatching_atand_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::atand_, Site>();
   }
   template<class... Args>
   struct impl_atand_;
  }

...
namespace nt2 { namespace tag
   ...
   **/
    struct acosd_ : ext::elementwise_<acosd_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_acosd_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
   template<class Site, class... Ts>
   BOOST_FORCEINLINE generic_dispatcher<tag::acosd_, Site> dispatching_acosd_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::acosd_, Site>();
   }
   template<class... Args>
   struct impl_acosd_;
  }

...
namespace nt2 {
   ...
   **/
    struct atanpi_ : ext::elementwise_<atanpi_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_atanpi_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
   template<class Site, class... Ts>
   BOOST_FORCEINLINE generic_dispatcher<tag::atanpi_, Site> dispatching_atanpi_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::atanpi_, Site>();
   }
   template<class... Args>
   struct impl_atanpi_;
  }

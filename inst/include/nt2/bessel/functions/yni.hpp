...
namespace nt2 { namespace tag
   ...
   **/
    struct yni_ : ext::elementwise_<yni_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_yni_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
   template<class Site, class... Ts>
   BOOST_FORCEINLINE generic_dispatcher<tag::yni_, Site> dispatching_yni_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::yni_, Site>();
   }
   template<class... Args>
   struct impl_yni_;
  }

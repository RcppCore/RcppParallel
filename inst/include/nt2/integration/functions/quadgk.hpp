...
namespace nt2
{
  ...
  namespace ext
  {
    ...
    BOOST_FORCEINLINE generic_dispatcher<tag::quadgk_, Site> dispatching_quadgk_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
    {
    ...
    template<class Site, class... Ts>
    BOOST_FORCEINLINE generic_dispatcher<tag::Quadgkabstol, Site> dispatching_Quadgkabstol(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
    {
    ...
    template<class Site, class... Ts>
    BOOST_FORCEINLINE generic_dispatcher<tag::Quadgkreltol, Site> dispatching_Quadgkreltol(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
    {

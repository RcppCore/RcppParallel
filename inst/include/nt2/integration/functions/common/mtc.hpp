...
//==============================================================================
#ifndef NT2_INTEGRATION_FUNCTIONS_COMMON_MTC_HPP_INCLUDED
#define NT2_INTEGRATION_FUNCTIONS_COMMON_MTC_HPP_INCLUDED
...
{
  BOOST_DISPATCH_IMPLEMENT  ( mtc_, tag::cpu_
                              , (F)(X)(O)
                              , (unspecified_< F >)

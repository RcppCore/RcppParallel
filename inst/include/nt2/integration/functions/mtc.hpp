...
namespace nt2
{
  namespace tag
  {
    struct mtc_ : ext::unspecified_<mtc_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_mtc_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
    template<class Site, class... Ts>
    BOOST_FORCEINLINE generic_dispatcher<tag::mtc_, Site> dispatching_mtc_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
    {
      return generic_dispatcher<tag::mtc_, Site>();
    }
    template<class... Args>
    struct impl_mtc_;
  }

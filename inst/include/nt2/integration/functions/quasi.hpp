...
namespace nt2 { namespace tag
   ...
   **/
    struct quasi_ : ext::unspecified_<quasi_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_quasi_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
   template<class Site, class... Ts>
   BOOST_FORCEINLINE generic_dispatcher<tag::quasi_, Site> dispatching_quasi_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::quasi_, Site>();
   }
   template<class... Args>
   struct impl_quasi_;
  }

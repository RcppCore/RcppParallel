  ...
  namespace tag
  {
    ...
    **/
    struct diff_ : ext::elementwise_<diff_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_diff_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
    template<class Site, class... Ts>
    BOOST_FORCEINLINE generic_dispatcher<tag::diff_, Site> dispatching_diff_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
    {
      return generic_dispatcher<tag::diff_, Site>();
    }
    template<class... Args>
    struct impl_diff_;
  }

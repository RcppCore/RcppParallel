  ...
  namespace tag
  {
    ...
    **/
    struct tri1u_ : ext::elementwise_<tri1u_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_tri1u_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
    template<class Site, class... Ts>
    BOOST_FORCEINLINE generic_dispatcher<tag::tri1u_, Site> dispatching_tri1u_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
    {
      return generic_dispatcher<tag::tri1u_, Site>();
    }
    template<class... Args>
    struct impl_tri1u_;
  }

...
//==============================================================================
#ifndef NT2_CORE_FUNCTIONS_EXPR_TRI1L_HPP_INCLUDED
#define NT2_CORE_FUNCTIONS_EXPR_TRI1L_HPP_INCLUDED
...
namespace nt2 { namespace ext
{
  ...
  BOOST_DISPATCH_IMPLEMENT  ( tri1l_, tag::cpu_
                            , (A0)
                            ...
                            )
  {
    ...
    BOOST_FORCEINLINE result_type operator()(A0 const& a0) const
    {
      ...
      BOOST_ASSERT_MSG( nt2::ismatrix(a0)
                      , "Error using tri1l: First input must be 2D."
                      );

      return boost::proto::make_expr< nt2::tag::tri1l_
                                    , container::domain
                                    > ( boost::cref(a0) );
    }
  };

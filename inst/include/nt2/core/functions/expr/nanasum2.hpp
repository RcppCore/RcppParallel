...
//==============================================================================
#ifndef NT2_CORE_FUNCTIONS_EXPR_NANASUM2_HPP_INCLUDED
#define NT2_CORE_FUNCTIONS_EXPR_NANASUM2_HPP_INCLUDED
...
namespace nt2 { namespace ext
{
                              ...
                              ((ast_<A0, nt2::container::domain>)) )
  {
    ...
    typedef typename meta::call < nt2::tag::if_zero_else_(T2, T3)>::type T4;
    typedef typename meta::call < nt2::tag::sum_(T4)>::type  result_type;
                              ...
                              )
  {
    ...
    typedef typename meta::call < nt2::tag::sqr_abs_(A0 const&)>::type T3;
    typedef typename meta::call < nt2::tag::if_zero_else_(T2, T3)>::type T4;
    typedef typename meta::call < nt2::tag::sum_(T4, A1 const &)>::type  result_type;

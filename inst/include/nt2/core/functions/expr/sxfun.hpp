...
//==============================================================================
#ifndef NT2_CORE_FUNCTIONS_EXPR_SXFUN_HPP_INCLUDED
#define NT2_CORE_FUNCTIONS_EXPR_SXFUN_HPP_INCLUDED
...
namespace nt2 { namespace ext
{
                            ...
                            )
  {
    ...
    typedef typename meta::call<tag::arrayfun_(const A0&, t1_t, t2_t)>::type result_type;

    BOOST_FORCEINLINE result_type operator()(A0 const& a0, A1 const& a1, A2 const& a2) const
    {
      ext_t s = nt2::utility::max_extent(a1, a2);
      return nt2::arrayfun(a0, nt2::expand_to(a1, s), nt2::expand_to(a2, s));
    }
  };
                            ...
                            )
  {
    ...
    typedef typename meta::call<tag::arrayfun_(const A0&, t1_t, t2_t, t3_t)>::type result_type;
                                             ...
                                             A2 const& a2, A3 const& a3) const
    {
      ...
      return nt2::arrayfun(a0, nt2::expand_to(a1, s), nt2::expand_to(a2, s), nt2::expand_to(a3, s));
    }
  };
} }

...
//==============================================================================
#ifndef NT2_CORE_FUNCTIONS_EXPR_FINDI_HPP_INCLUDED
#define NT2_CORE_FUNCTIONS_EXPR_FINDI_HPP_INCLUDED
...
namespace nt2 { namespace ext
{
  ...
  {
    typedef typename meta::call < tag::findi_(A0 const&
                                , meta::as_<std::ptrdiff_t>)
                                >::type                       result_type;

    result_type operator()(A0 const& a0) const
    {
      return nt2::findi(a0, meta::as_<std::ptrdiff_t>());
    }
  };

...
//==============================================================================
#ifndef NT2_CORE_FUNCTIONS_EXPR_SETDIFF_HPP_INCLUDED
#define NT2_CORE_FUNCTIONS_EXPR_SETDIFF_HPP_INCLUDED

#include <nt2/core/functions/setdiff.hpp>
...
namespace nt2 { namespace ext
{
  BOOST_DISPATCH_IMPLEMENT  ( run_assign_, tag::cpu_
                            ...
                            , ((ast_<A0, nt2::container::domain>))
                              ((node_<A1,nt2::tag::setdiff_,N,nt2::container::domain>))
                            )
  {
    ...
    result_type operator()(A0& out, const A1& in) const
    {
      ...
      auto last = std::set_difference(a.begin(),a.end(),b.begin(),b.end(),r.begin());

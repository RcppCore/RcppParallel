...
namespace nt2
{
  namespace tag
  {
    ...
    struct randn_ : ext::unspecified_<randn_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_randn_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
    template<class Site, class... Ts>
    BOOST_FORCEINLINE generic_dispatcher<tag::randn_, Site> dispatching_randn_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
    {
      return generic_dispatcher<tag::randn_, Site>();
    }
    template<class... Args>
    struct impl_randn_;
  }

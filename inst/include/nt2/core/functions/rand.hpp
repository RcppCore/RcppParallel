...
namespace nt2
{
  namespace tag
  {
    ...
    struct rand_ : ext::unspecified_<rand_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_rand_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
    template<class Site, class... Ts>
    BOOST_FORCEINLINE generic_dispatcher<tag::rand_, Site> dispatching_rand_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
    {
      return generic_dispatcher<tag::rand_, Site>();
    }
    template<class... Args>
    struct impl_rand_;
  }

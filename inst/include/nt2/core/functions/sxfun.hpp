...
namespace nt2
{
  namespace tag
  {
     ...
     **/
    struct sxfun_ : ext::abstract_<sxfun_>
    {
      typedef ext::abstract_<sxfun_> parent;
      template<class... Args>
      static BOOST_FORCEINLINE BOOST_AUTO_DECLTYPE dispatch(Args&&... args)
      BOOST_AUTO_DECLTYPE_BODY( dispatching_sxfun_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
    template<class Site, class... Ts>
    BOOST_FORCEINLINE generic_dispatcher<tag::sxfun_, Site> dispatching_sxfun_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
    {
      return generic_dispatcher<tag::sxfun_, Site>();
    }
    template<class... Args>
    struct impl_sxfun_;
  }

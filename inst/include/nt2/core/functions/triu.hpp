  ...
  namespace tag
  {
    ...
    **/
    struct triu_ : ext::elementwise_<triu_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_triu_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
    template<class Site, class... Ts>
    BOOST_FORCEINLINE generic_dispatcher<tag::triu_, Site> dispatching_triu_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
    {
      return generic_dispatcher<tag::triu_, Site>();
    }
    template<class... Args>
    struct impl_triu_;
  }

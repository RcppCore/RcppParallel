...
namespace nt2
{
   ...
   **/
    struct squeeze_ : ext::reshaping_<squeeze_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_squeeze_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
   template<class Site, class... Ts>
   BOOST_FORCEINLINE generic_dispatcher<tag::squeeze_, Site> dispatching_squeeze_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::squeeze_, Site>();
   }
   template<class... Args>
   struct impl_squeeze_;
  }

  ...
  namespace tag
  {
    ...
    **/
    struct aggregate_ : ext::elementwise_<aggregate_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_aggregate_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
    template<class Site, class... Ts>
    BOOST_FORCEINLINE generic_dispatcher<tag::aggregate_, Site> dispatching_aggregate_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
    {
      return generic_dispatcher<tag::aggregate_, Site>();
    }
    template<class... Args>
    struct impl_aggregate_;
  }

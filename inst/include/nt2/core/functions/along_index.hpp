...
namespace nt2
{
   ...
   **/
    struct along_index_ : ext::elementwise_<along_index_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_along_index_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
   template<class Site, class... Ts>
   BOOST_FORCEINLINE generic_dispatcher<tag::along_index_, Site> dispatching_along_index_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::along_index_, Site>();
   }
   template<class... Args>
   struct impl_along_index_;
  }
  /*!

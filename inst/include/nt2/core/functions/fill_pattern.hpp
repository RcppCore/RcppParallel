...
namespace nt2
{
  ...
  namespace ext
  {
    ...
    BOOST_FORCEINLINE generic_dispatcher<tag::fill_pattern_, Site> dispatching_fill_pattern_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
    {

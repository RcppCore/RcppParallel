  ...
  namespace tag
  {
    ...
    **/
    struct adjfun_ : ext::elementwise_<adjfun_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_adjfun_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
    template<class Site, class... Ts>
    BOOST_FORCEINLINE generic_dispatcher<tag::adjfun_, Site> dispatching_adjfun_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
    {
      return generic_dispatcher<tag::adjfun_, Site>();
    }
    template<class... Args>
    struct impl_adjfun_;
  }

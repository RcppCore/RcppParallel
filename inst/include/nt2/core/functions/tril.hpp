  ...
  namespace tag
  {
    ...
    **/
    struct tril_ : ext::elementwise_<tril_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_tril_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
    template<class Site, class... Ts>
    BOOST_FORCEINLINE generic_dispatcher<tag::tril_, Site> dispatching_tril_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
    {
      return generic_dispatcher<tag::tril_, Site>();
    }
    template<class... Args>
    struct impl_tril_;
  }

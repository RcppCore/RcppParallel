...
namespace nt2
{
  namespace tag
  {
    ...
    **/
    struct nanmean_ : ext::abstract_<nanmean_>
    {
      /// @brief Parent hierarchy
      typedef ext::abstract_<nanmean_> parent;
      template<class... Args>
      static BOOST_FORCEINLINE BOOST_AUTO_DECLTYPE dispatch(Args&&... args)
      BOOST_AUTO_DECLTYPE_BODY( dispatching_nanmean_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
    template<class Site, class... Ts>
    BOOST_FORCEINLINE generic_dispatcher<tag::nanmean_, Site> dispatching_nanmean_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
    {
      return generic_dispatcher<tag::nanmean_, Site>();
    }
    template<class... Args>
    struct impl_nanmean_;
  }
  /*!

...
namespace nt2
{
  namespace tag
  {
    struct function_ : ext::elementwise_<function_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_function_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
    template<class Site, class... Ts>
    BOOST_FORCEINLINE generic_dispatcher<tag::function_, Site> dispatching_function_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
    {
      return generic_dispatcher<tag::function_, Site>();
    }
    template<class... Args>
    struct impl_function_;
  }

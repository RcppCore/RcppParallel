...
namespace nt2
{
   ...
   **/
    struct rowvect_ : ext::reshaping_<rowvect_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_rowvect_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
   template<class Site, class... Ts>
   BOOST_FORCEINLINE generic_dispatcher<tag::rowvect_, Site> dispatching_rowvect_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::rowvect_, Site>();
   }
   template<class... Args>
   struct impl_rowvect_;
  }
  /*!

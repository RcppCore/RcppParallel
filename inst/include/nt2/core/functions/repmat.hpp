...
namespace nt2
{
  namespace tag
  {
    struct  repmat_ : ext::elementwise_<repmat_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_repmat_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
    template<class Site, class... Ts>
    BOOST_FORCEINLINE generic_dispatcher<tag::repmat_, Site> dispatching_repmat_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
    {
      return generic_dispatcher<tag::repmat_, Site>();
    }
    template<class... Args>
    struct impl_repmat_;
  }

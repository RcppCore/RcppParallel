...
namespace nt2
{
   ...
   **/
    struct ctranspose_ : ext::elementwise_<ctranspose_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_ctranspose_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
   template<class Site, class... Ts>
   BOOST_FORCEINLINE generic_dispatcher<tag::ctranspose_, Site> dispatching_ctranspose_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::ctranspose_, Site>();
   }
   template<class... Args>
   struct impl_ctranspose_;
  }
  /*!

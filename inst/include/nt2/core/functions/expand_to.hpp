...
namespace nt2
{
   ...
   **/
    struct expand_to_ : ext::elementwise_<expand_to_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_expand_to_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
   template<class Site, class... Ts>
   BOOST_FORCEINLINE generic_dispatcher<tag::expand_to_, Site> dispatching_expand_to_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::expand_to_, Site>();
   }
   template<class... Args>
   struct impl_expand_to_;
  }

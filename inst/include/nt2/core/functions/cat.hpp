...
namespace nt2
{
  namespace tag
  {
    ...
    struct cat_ : ext::unspecified_<cat_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_cat_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  ...
  namespace ext
  {
    ...
    BOOST_FORCEINLINE generic_dispatcher<tag::cat_, Site> dispatching_cat_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
    {
      return generic_dispatcher<tag::cat_, Site>();
    }
    template<class... Args>
    struct impl_cat_;
  }
  ...
  struct  size_of<nt2::tag::cat_,Domain,N,Expr>
  {
    ...
    BOOST_FORCEINLINE result_type operator ()(Expr& e) const
    {
      ...
      else
      {
        ...
        sizee[along-1] += nt2::size(boost::proto::child_c<2>(e),along);

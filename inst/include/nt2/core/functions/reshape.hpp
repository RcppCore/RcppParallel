...
namespace nt2
{
  namespace tag
  {
    struct reshape_ : ext::reshaping_<reshape_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_reshape_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
    template<class Site, class... Ts>
    BOOST_FORCEINLINE generic_dispatcher<tag::reshape_, Site> dispatching_reshape_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
    {
      return generic_dispatcher<tag::reshape_, Site>();
    }
    template<class... Args>
    struct impl_reshape_;
  }

...
namespace nt2
{
   ...
   **/
    struct transpose_ : ext::elementwise_<transpose_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_transpose_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
   template<class Site, class... Ts>
   BOOST_FORCEINLINE generic_dispatcher<tag::transpose_, Site> dispatching_transpose_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::transpose_, Site>();
   }
   template<class... Args>
   struct impl_transpose_;
  }
  /*!

...
namespace nt2
{
  ...
  namespace ext
  {
   ...
   BOOST_FORCEINLINE generic_dispatcher<tag::flipdim_, Site> dispatching_flipdim_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {

...
//==============================================================================
#ifndef NT2_CORE_FUNCTIONS_TWOOFIVE_HPP_INCLUDED
...
{
  #define M0(z,n,t)                                    \
  NT2_FUNCTION_IMPLEMENTATION(nt2::tag::Twoofive,twoofive, n) \
  /**/
...
namespace nt2 { namespace ext
{
  ...
  struct  value_type<tag::Twoofive,Domain,N,Expr>
        : meta::generative_value<Expr>
  {};

  /// INTERNAL ONLY
  template<typename Domain, typename Expr, int N>
  struct  size_of<tag::Twoofive,Domain,N,Expr>

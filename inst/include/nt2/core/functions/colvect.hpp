...
namespace nt2
{
   ...
   **/
    struct colvect_ : ext::reshaping_<colvect_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_colvect_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
   template<class Site, class... Ts>
   BOOST_FORCEINLINE generic_dispatcher<tag::colvect_, Site> dispatching_colvect_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::colvect_, Site>();
   }
   template<class... Args>
   struct impl_colvect_;
  }
  /*!

...
namespace nt2 { namespace tag
   ...
   **/
    struct roots_ : ext::unspecified_<roots_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_roots_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
   template<class Site, class... Ts>
   BOOST_FORCEINLINE generic_dispatcher<tag::roots_, Site> dispatching_roots_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::roots_, Site>();
   }
   template<class... Args>
   struct impl_roots_;
  }

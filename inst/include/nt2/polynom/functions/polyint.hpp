...
namespace nt2 { namespace tag
   ...
   **/
    struct polyint_ : ext::elementwise_<polyint_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_polyint_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
   template<class Site, class... Ts>
   BOOST_FORCEINLINE generic_dispatcher<tag::polyint_, Site> dispatching_polyint_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::polyint_, Site>();
   }
   template<class... Args>
   struct impl_polyint_;
  }
  /*!

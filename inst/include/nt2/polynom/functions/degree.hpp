...
namespace nt2 { namespace tag
   ...
   **/
    struct degree_ : ext::elementwise_<degree_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_degree_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
   template<class Site, class... Ts>
   BOOST_FORCEINLINE generic_dispatcher<tag::degree_, Site> dispatching_degree_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::degree_, Site>();
   }
   template<class... Args>
   struct impl_degree_;
  }

...
namespace nt2 { namespace tag
   ...
   **/
    struct polyder_ : ext::elementwise_<polyder_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_polyder_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
   template<class Site, class... Ts>
   BOOST_FORCEINLINE generic_dispatcher<tag::polyder_, Site> dispatching_polyder_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::polyder_, Site>();
   }
   template<class... Args>
   struct impl_polyder_;
  }
  /*!

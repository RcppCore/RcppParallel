...
namespace nt2 { namespace tag
   ...
   **/
    struct polyvalm_ : ext::unspecified_<polyvalm_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_polyvalm_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
   template<class Site, class... Ts>
   BOOST_FORCEINLINE generic_dispatcher<tag::polyvalm_, Site> dispatching_polyvalm_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::polyvalm_, Site>();
   }
   template<class... Args>
   struct impl_polyvalm_;
  }
  /*!

...
//==============================================================================
#ifndef NT2_POLYNOM_FUNCTIONS_EXPR_POLYSUB_HPP_INCLUDED
#define NT2_POLYNOM_FUNCTIONS_EXPR_POLYSUB_HPP_INCLUDED
...
{
   BOOST_DISPATCH_IMPLEMENT  ( polysub_, tag::cpu_,
                              (A0),
                            ...
                            )
  {
    BOOST_DISPATCH_RETURNS(2, (A0 const& a0, A0 const& a1),
                           ( polysub(nt2::_(a0, a0), nt2::_(a1, a1)))
                          )
  };
                            ...
                            )
  {
    ...
    typedef typename nt2::meta::call<nt2::tag::minus_(T0, T1)>::type                                 T2;

...
namespace nt2 { namespace tag
   ...
   **/
    struct ratfracder_ : ext::tieable_<ratfracder_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_ratfracder_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
   template<class Site, class... Ts>
   BOOST_FORCEINLINE generic_dispatcher<tag::ratfracder_, Site> dispatching_ratfracder_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::ratfracder_, Site>();
   }
   template<class... Args>
   struct impl_ratfracder_;
  }
  /*!

...
namespace nt2 { namespace tag
   ...
   **/
    struct polyfit_ : ext::tieable_<polyfit_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_polyfit_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
   template<class Site, class... Ts>
   BOOST_FORCEINLINE generic_dispatcher<tag::polyfit_, Site> dispatching_polyfit_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::polyfit_, Site>();
   }
   template<class... Args>
   struct impl_polyfit_;
  }
  /*!

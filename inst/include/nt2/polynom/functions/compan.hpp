...
namespace nt2 { namespace tag
   ...
   **/
    struct compan_ : ext::elementwise_<compan_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_compan_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
   template<class Site, class... Ts>
   BOOST_FORCEINLINE generic_dispatcher<tag::compan_, Site> dispatching_compan_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::compan_, Site>();
   }
   template<class... Args>
   struct impl_compan_;
  }

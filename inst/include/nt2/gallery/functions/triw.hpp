...
namespace nt2 { namespace tag
  {
    ...
    **/
    struct triw_ : ext::abstract_<triw_>
    {
      typedef ext::abstract_<triw_> parent;
      template<class... Args>
      static BOOST_FORCEINLINE BOOST_AUTO_DECLTYPE dispatch(Args&&... args)
      BOOST_AUTO_DECLTYPE_BODY( dispatching_triw_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
    template<class Site, class... Ts>
    BOOST_FORCEINLINE generic_dispatcher<tag::triw_, Site> dispatching_triw_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
    {
      return generic_dispatcher<tag::triw_, Site>();
    }
    template<class... Args>
    struct impl_triw_;
  }

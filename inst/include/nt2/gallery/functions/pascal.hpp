...
namespace nt2 { namespace tag
  {
    ...
    **/
    struct pascal_ :  ext::unspecified_<pascal_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_pascal_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
    template<class Site, class... Ts>
    BOOST_FORCEINLINE generic_dispatcher<tag::pascal_, Site> dispatching_pascal_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
    {
      return generic_dispatcher<tag::pascal_, Site>();
    }
    template<class... Args>
    struct impl_pascal_;
  }

...
namespace nt2 { namespace tag
  ...
  namespace ext
  {
    ...
    BOOST_FORCEINLINE generic_dispatcher<tag::randcolu0_, Site> dispatching_randcolu0_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
    {
    ...
    template<class Site, class... Ts>
    BOOST_FORCEINLINE generic_dispatcher<tag::randcolu_, Site> dispatching_randcolu_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
    {

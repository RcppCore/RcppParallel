...
namespace nt2 { namespace tag
  {
     ...
     **/
    struct randcorr0_ : ext::abstract_<randcorr0_>
    {
      typedef ext::abstract_<randcorr0_> parent;
      template<class... Args>
      static BOOST_FORCEINLINE BOOST_AUTO_DECLTYPE dispatch(Args&&... args)
      BOOST_AUTO_DECLTYPE_BODY( dispatching_randcorr0_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  ...
  namespace ext
  {
    ...
    BOOST_FORCEINLINE generic_dispatcher<tag::randcorr0_, Site> dispatching_randcorr0_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
    {
    ...
    template<class Site, class... Ts>
    BOOST_FORCEINLINE generic_dispatcher<tag::randcorr_, Site> dispatching_randcorr_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
    {

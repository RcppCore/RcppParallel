...
namespace nt2 { namespace tag
  {
    ...
    **/
    struct tridiag_ : ext::abstract_<tridiag_>
    {
      typedef ext::abstract_<tridiag_> parent;
      template<class... Args>
      static BOOST_FORCEINLINE BOOST_AUTO_DECLTYPE dispatch(Args&&... args)
      BOOST_AUTO_DECLTYPE_BODY( dispatching_tridiag_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
    template<class Site, class... Ts>
    BOOST_FORCEINLINE generic_dispatcher<tag::tridiag_, Site> dispatching_tridiag_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
    {
      return generic_dispatcher<tag::tridiag_, Site>();
    }
    template<class... Args>
    struct impl_tridiag_;
  }

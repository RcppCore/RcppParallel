  ...
  namespace tag
  {
    ...
    **/
    struct kms_ :  ext::unspecified_<kms_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_kms_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
    template<class Site, class... Ts>
    BOOST_FORCEINLINE generic_dispatcher<tag::kms_, Site> dispatching_kms_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
    {
      return generic_dispatcher<tag::kms_, Site>();
    }
    template<class... Args>
    struct impl_kms_;
  }

...
namespace nt2 { namespace tag
  {
    ...
    **/
    struct leslie_ : ext::abstract_<leslie_>
    {
      typedef ext::abstract_<leslie_> parent;
      template<class... Args>
      static BOOST_FORCEINLINE BOOST_AUTO_DECLTYPE dispatch(Args&&... args)
      BOOST_AUTO_DECLTYPE_BODY( dispatching_leslie_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
    template<class Site, class... Ts>
    BOOST_FORCEINLINE generic_dispatcher<tag::leslie_, Site> dispatching_leslie_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
    {
      return generic_dispatcher<tag::leslie_, Site>();
    }
    template<class... Args>
    struct impl_leslie_;
  }

...
namespace nt2 { namespace tag
  ...
  namespace ext
  {
    ...
    BOOST_FORCEINLINE generic_dispatcher<tag::randhess0_, Site> dispatching_randhess0_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
    {
    ...
    template<class Site, class... Ts>
    BOOST_FORCEINLINE generic_dispatcher<tag::randhess_, Site> dispatching_randhess_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
    {

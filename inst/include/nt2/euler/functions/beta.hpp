...
namespace nt2
{
   ...
   **/
    struct beta_ : ext::elementwise_<beta_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_beta_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
   template<class Site, class... Ts>
   BOOST_FORCEINLINE generic_dispatcher<tag::beta_, Site> dispatching_beta_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::beta_, Site>();
   }
   template<class... Args>
   struct impl_beta_;
  }

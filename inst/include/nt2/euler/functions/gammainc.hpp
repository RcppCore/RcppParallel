...
namespace nt2 { namespace tag
   ...
   **/
    struct gammainc_ : ext::elementwise_<gammainc_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_gammainc_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
   template<class Site, class... Ts>
   BOOST_FORCEINLINE generic_dispatcher<tag::gammainc_, Site> dispatching_gammainc_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::gammainc_, Site>();
   }
   template<class... Args>
   struct impl_gammainc_;
  }

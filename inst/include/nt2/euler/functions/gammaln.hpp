...
namespace nt2 { namespace tag
   ...
   **/
    struct gammaln_ : ext::elementwise_<gammaln_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_gammaln_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
   template<class Site, class... Ts>
   BOOST_FORCEINLINE generic_dispatcher<tag::gammaln_, Site> dispatching_gammaln_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::gammaln_, Site>();
   }
   template<class... Args>
   struct impl_gammaln_;
  }
  /*!

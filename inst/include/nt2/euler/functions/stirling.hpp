...
namespace nt2 { namespace tag
   ...
   **/
    struct stirling_ : ext::elementwise_<stirling_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_stirling_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
   template<class Site, class... Ts>
   BOOST_FORCEINLINE generic_dispatcher<tag::stirling_, Site> dispatching_stirling_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::stirling_, Site>();
   }
   template<class... Args>
   struct impl_stirling_;
  }
  /*!

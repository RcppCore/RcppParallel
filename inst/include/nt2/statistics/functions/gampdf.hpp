...
namespace nt2 { namespace tag
   ...
   **/
    struct gampdf_ : ext::elementwise_<gampdf_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_gampdf_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
   template<class Site, class... Ts>
   BOOST_FORCEINLINE generic_dispatcher<tag::gampdf_, Site> dispatching_gampdf_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::gampdf_, Site>();
   }
   template<class... Args>
   struct impl_gampdf_;
  }

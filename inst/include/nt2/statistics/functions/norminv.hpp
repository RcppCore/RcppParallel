...
namespace nt2 { namespace tag
  ...
  namespace ext
  {
   ...
   BOOST_FORCEINLINE generic_dispatcher<tag::norminv_, Site> dispatching_norminv_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
   ...
   template<class Site, class... Ts>
   BOOST_FORCEINLINE generic_dispatcher<tag::norminv0_, Site> dispatching_norminv0_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {

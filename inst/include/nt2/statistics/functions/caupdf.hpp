...
namespace nt2 { namespace tag
   ...
   **/
    struct caupdf_ : ext::elementwise_<caupdf_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_caupdf_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
   template<class Site, class... Ts>
   BOOST_FORCEINLINE generic_dispatcher<tag::caupdf_, Site> dispatching_caupdf_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::caupdf_, Site>();
   }
   template<class... Args>
   struct impl_caupdf_;
  }

...
namespace nt2 { namespace tag
   ...
   **/
    struct caucdf_ : ext::elementwise_<caucdf_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_caucdf_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
   template<class Site, class... Ts>
   BOOST_FORCEINLINE generic_dispatcher<tag::caucdf_, Site> dispatching_caucdf_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::caucdf_, Site>();
   }
   template<class... Args>
   struct impl_caucdf_;
  }

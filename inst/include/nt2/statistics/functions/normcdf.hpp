...
namespace nt2 { namespace tag
   ...
   **/
    struct normcdf_ : ext::tieable_<normcdf_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_normcdf_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  ...
  namespace ext
  {
   ...
   BOOST_FORCEINLINE generic_dispatcher<tag::normcdf_, Site> dispatching_normcdf_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::normcdf_, Site>();
   }
   template<class... Args>
   struct impl_normcdf_;
   template<class Site, class... Ts>
   BOOST_FORCEINLINE generic_dispatcher<tag::normcdf0_, Site> dispatching_normcdf0_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {

...
namespace nt2 { namespace tag
   ...
   **/
    struct unifinv_ : ext::elementwise_<unifinv_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_unifinv_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
   template<class Site, class... Ts>
   BOOST_FORCEINLINE generic_dispatcher<tag::unifinv_, Site> dispatching_unifinv_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::unifinv_, Site>();
   }
   template<class... Args>
   struct impl_unifinv_;
  }
  /*!

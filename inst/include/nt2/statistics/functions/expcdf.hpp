...
namespace nt2 { namespace tag
   ...
   **/
    ...
    struct expcdf0_: ext::elementwise_<expcdf0_>
    {
      ...
      template<class... Args>
      static BOOST_FORCEINLINE BOOST_AUTO_DECLTYPE dispatch(Args&&... args)
      BOOST_AUTO_DECLTYPE_BODY( dispatching_expcdf0_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
   template<class Site, class... Ts>
   BOOST_FORCEINLINE generic_dispatcher<tag::expcdf_, Site> dispatching_expcdf_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
   ...
   struct impl_expcdf_;
   template<class Site, class... Ts>
   BOOST_FORCEINLINE generic_dispatcher<tag::expcdf0_, Site> dispatching_expcdf0_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::expcdf0_, Site>();
   }
   template<class... Args>
   struct impl_expcdf0_;
  }
  /*!

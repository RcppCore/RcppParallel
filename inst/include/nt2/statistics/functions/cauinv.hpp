...
namespace nt2 { namespace tag
   ...
   **/
    struct cauinv_ : ext::elementwise_<cauinv_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_cauinv_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
   template<class Site, class... Ts>
   BOOST_FORCEINLINE generic_dispatcher<tag::cauinv_, Site> dispatching_cauinv_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::cauinv_, Site>();
   }
   template<class... Args>
   struct impl_cauinv_;
  }

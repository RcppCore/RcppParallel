...
namespace nt2
{
  ...
  namespace ext
  {
      ...
      BOOST_FORCEINLINE generic_dispatcher<tag::eyeplus_, Site> dispatching_eyeplus_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
      {

...
namespace nt2
{
  namespace tag
  {
    struct svd_ : ext::tieable_<svd_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_svd_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
    template<class Site, class... Ts>
    BOOST_FORCEINLINE generic_dispatcher<tag::svd_, Site> dispatching_svd_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
    {
      return generic_dispatcher<tag::svd_, Site>();
    }
    template<class... Args>
    struct impl_svd_;
  }

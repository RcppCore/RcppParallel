...
namespace nt2
{
  namespace tag
  {
    struct lu_ : ext::tieable_<lu_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_lu_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
    template<class Site, class... Ts>
    BOOST_FORCEINLINE generic_dispatcher<tag::lu_, Site> dispatching_lu_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
    {
      return generic_dispatcher<tag::lu_, Site>();
    }
    template<class... Args>
    struct impl_lu_;
  }

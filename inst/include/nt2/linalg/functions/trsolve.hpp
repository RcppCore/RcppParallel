  ...
  namespace tag
  {
    ...
    **/
    struct trsolve_ : ext::unspecified_<trsolve_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_trsolve_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
    template<class Site, class... Ts>
    BOOST_FORCEINLINE generic_dispatcher<tag::trsolve_, Site> dispatching_trsolve_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
    {
      return generic_dispatcher<tag::trsolve_, Site>();
    }
    template<class... Args>
    struct impl_trsolve_;
  }

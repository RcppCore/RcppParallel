...
//==============================================================================
#ifndef NT2_LINALG_FUNCTIONS_LAPACK_GENERAL_GECON_HPP_INCLUDED
#define NT2_LINALG_FUNCTIONS_LAPACK_GENERAL_GECON_HPP_INCLUDED
...
{
  /// INTERNAL ONLY
  BOOST_DISPATCH_IMPLEMENT  ( gecon_, tag::cpu_
                            , (A0)(S0)(A1)(A2)
                            ...
                            )
  {
    ...
    BOOST_FORCEINLINE result_type operator()(A0 const& a0, A1 const& a1, A2 const& a2) const
    {
      ...
      NT2_F77NAME(dgecon) ( &a1, &n, a0.data(), &ld, &a2, &rcond , work.data()
                          , iwork.data(), &info
                          );
                            ...
                            )
  {
    ...
    BOOST_FORCEINLINE result_type operator()(A0 const& a0, A1 const& a1, A2 const& a2) const
    {
      ...
      NT2_F77NAME(sgecon) ( &a1, &n, a0.data(), &ld, &a2, &rcond , work.data()
                          , iwork.data(), &info
                          );
                            ...
                            )
  {
    ...
    BOOST_FORCEINLINE result_type operator()(A0 const& a0, A1 const& a1, A2 const& a2) const
    {
      ...
      NT2_F77NAME(zgecon) ( &a1, &n, a0.data(), &ld, &a2, &rcond , work.data()
                          , rwork.data(), &info
                          );
                            ...
                            )
  {
    ...
    BOOST_FORCEINLINE result_type operator()(A0 const& a0, A1 const& a1, A2 const& a2) const
    {
      ...
      NT2_F77NAME(cgecon) ( &a1, &n, a0.data(), &ld, &a2, &rcond , work.data()
                          , rwork.data(), &info
                          );

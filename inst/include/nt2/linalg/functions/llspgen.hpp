...
namespace nt2
{
  namespace tag
  {
    struct llspgen_ : ext::tieable_<llspgen_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_llspgen_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
    template<class Site, class... Ts>
    BOOST_FORCEINLINE generic_dispatcher<tag::llspgen_, Site> dispatching_llspgen_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
    {
      return generic_dispatcher<tag::llspgen_, Site>();
    }
    template<class... Args>
    struct impl_llspgen_;
  }

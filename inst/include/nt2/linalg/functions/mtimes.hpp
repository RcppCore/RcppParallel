  ...
  namespace tag
  {
    ...
    **/
    struct mtimes_ : ext::unspecified_<mtimes_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_mtimes_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
    template<class Site, class... Ts>
    BOOST_FORCEINLINE generic_dispatcher<tag::mtimes_, Site> dispatching_mtimes_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
    {
      return generic_dispatcher<tag::mtimes_, Site>();
    }
    template<class... Args>
    struct impl_mtimes_;
  }

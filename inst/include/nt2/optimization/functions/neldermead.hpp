  ...
  namespace tag
  {
    ...
    **/
    struct neldermead_ : ext::unspecified_<neldermead_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_neldermead_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
    template<class Site, class... Ts>
    BOOST_FORCEINLINE generic_dispatcher<tag::neldermead_, Site> dispatching_neldermead_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
    {
      return generic_dispatcher<tag::neldermead_, Site>();
    }
    template<class... Args>
    struct impl_neldermead_;
  }
  /*!

...
namespace nt2
{
   ...
   **/
    struct levenberg_ : ext::unspecified_<levenberg_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_levenberg_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
   template<class Site, class... Ts>
   BOOST_FORCEINLINE generic_dispatcher<tag::levenberg_, Site> dispatching_levenberg_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::levenberg_, Site>();
   }
   template<class... Args>
   struct impl_levenberg_;
  }
  /*!

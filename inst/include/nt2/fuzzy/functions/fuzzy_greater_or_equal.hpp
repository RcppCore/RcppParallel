...
namespace nt2 { namespace tag
  ...
  namespace ext
  {
   ...
   BOOST_FORCEINLINE generic_dispatcher<tag::fuzzy_greater_or_equal_, Site> dispatching_fuzzy_greater_or_equal_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {

...
namespace nt2 { namespace tag
   ...
   **/
    struct knuth_equal_ : ext::elementwise_<knuth_equal_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_knuth_equal_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
   template<class Site, class... Ts>
   BOOST_FORCEINLINE generic_dispatcher<tag::knuth_equal_, Site> dispatching_knuth_equal_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::knuth_equal_, Site>();
   }
   template<class... Args>
   struct impl_knuth_equal_;
  }
  /*!

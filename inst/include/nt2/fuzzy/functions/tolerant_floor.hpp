...
namespace nt2 { namespace tag
   ...
   **/
    struct tolerant_floor_ : ext::elementwise_<tolerant_floor_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_tolerant_floor_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
   template<class Site, class... Ts>
   BOOST_FORCEINLINE generic_dispatcher<tag::tolerant_floor_, Site> dispatching_tolerant_floor_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::tolerant_floor_, Site>();
   }
   template<class... Args>
   struct impl_tolerant_floor_;
  }
  /*!

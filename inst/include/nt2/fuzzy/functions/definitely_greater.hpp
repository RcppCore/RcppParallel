...
namespace nt2 { namespace tag
   ...
   **/
    struct definitely_greater_ : ext::elementwise_<definitely_greater_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_definitely_greater_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
   template<class Site, class... Ts>
   BOOST_FORCEINLINE generic_dispatcher<tag::definitely_greater_, Site> dispatching_definitely_greater_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::definitely_greater_, Site>();
   }
   template<class... Args>
   struct impl_definitely_greater_;
  }
  /*!

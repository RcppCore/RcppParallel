...
namespace nt2 { namespace tag
   ...
   **/
    struct tolerant_ceil_ : ext::elementwise_<tolerant_ceil_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_tolerant_ceil_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
   template<class Site, class... Ts>
   BOOST_FORCEINLINE generic_dispatcher<tag::tolerant_ceil_, Site> dispatching_tolerant_ceil_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::tolerant_ceil_, Site>();
   }
   template<class... Args>
   struct impl_tolerant_ceil_;
  }
  /*!

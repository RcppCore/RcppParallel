...
namespace nt2 { namespace tag
   ...
   **/
    struct fuzzy_definitely_less_ : ext::elementwise_<fuzzy_definitely_less_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_fuzzy_definitely_less_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
   template<class Site, class... Ts>
   BOOST_FORCEINLINE generic_dispatcher<tag::fuzzy_definitely_less_, Site> dispatching_fuzzy_definitely_less_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::fuzzy_definitely_less_, Site>();
   }
   template<class... Args>
   struct impl_fuzzy_definitely_less_;
  }
  /*!

...
namespace boost { namespace simd { namespace ext
{
  ...
  {
    typedef typename boost::dispatch::meta::call< nt2::tag::minimum_(A0 const&)>::type result_type;
  ...
  {
    typedef typename boost::dispatch::meta::call< nt2::tag::minimum_(A0 const&, A2 const&)>::type result_type;

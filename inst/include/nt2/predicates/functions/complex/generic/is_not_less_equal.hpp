...
//==============================================================================
#ifndef NT2_PREDICATES_FUNCTIONS_COMPLEX_GENERIC_IS_NOT_LESS_EQUAL_HPP_INCLUDED
#define NT2_PREDICATES_FUNCTIONS_COMPLEX_GENERIC_IS_NOT_LESS_EQUAL_HPP_INCLUDED

#include <nt2/predicates/functions/is_not_less_equal.hpp>
...
namespace boost { namespace simd { namespace ext
{
                            ...
                            )
  {
    ...
    {
      return is_not_less_equal(nt2::real(a0),nt2::real(a1));
    }
  };
  // dry/dry
  BOOST_DISPATCH_IMPLEMENT  ( is_not_less_equal_, tag::cpu_, (A0)
                            ...
                            )
  {
    ...
    NT2_FUNCTOR_CALL(2)
    {
      return is_not_less_equal(nt2::real(a0), a1);
    }
  };
  // complex/dry
  BOOST_DISPATCH_IMPLEMENT  ( is_not_less_equal_, tag::cpu_, (A0)(A1)
                            ...
                            )
  {
    ...
    NT2_FUNCTOR_CALL(2)
    {
      return is_not_less_equal(nt2::real(a1),a0);
    }
  };
  // dry/complex
  BOOST_DISPATCH_IMPLEMENT  ( is_not_less_equal_, tag::cpu_, (A0)(A1),

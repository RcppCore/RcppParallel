...
namespace nt2 { namespace tag
   ...
   **/
    struct am_ : ext::elementwise_<am_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_am_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
   template<class Site, class... Ts>
   BOOST_FORCEINLINE generic_dispatcher<tag::am_, Site> dispatching_am_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::am_, Site>();
   }
   template<class... Args>
   struct impl_am_;
  }

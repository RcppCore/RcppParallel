...
namespace nt2 { namespace tag
   ...
   **/
    struct ellik_ : ext::elementwise_<ellik_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_ellik_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
   template<class Site, class... Ts>
   BOOST_FORCEINLINE generic_dispatcher<tag::ellik_, Site> dispatching_ellik_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::ellik_, Site>();
   }
   template<class... Args>
   struct impl_ellik_;
  }

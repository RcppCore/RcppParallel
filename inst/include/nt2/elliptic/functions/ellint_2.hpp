...
namespace nt2 { namespace tag
   ...
   **/
    struct ellint_2_ : ext::elementwise_<ellint_2_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_ellint_2_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
   template<class Site, class... Ts>
   BOOST_FORCEINLINE generic_dispatcher<tag::ellint_2_, Site> dispatching_ellint_2_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::ellint_2_, Site>();
   }
   template<class... Args>
   struct impl_ellint_2_;
  }
  /*!

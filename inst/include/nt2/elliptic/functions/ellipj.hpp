...
namespace nt2 { namespace tag
  {
    ...
    struct ellipj_ : ext::elementwise_<ellipj_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_ellipj_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
    template<class Site, class... Ts>
    BOOST_FORCEINLINE generic_dispatcher<tag::ellipj_, Site> dispatching_ellipj_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
    {
      return generic_dispatcher<tag::ellipj_, Site>();
    }
    template<class... Args>
    struct impl_ellipj_;
  }

...
namespace nt2 { namespace tag
   ...
   **/
    struct ellint_1_ : ext::elementwise_<ellint_1_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_ellint_1_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
   template<class Site, class... Ts>
   BOOST_FORCEINLINE generic_dispatcher<tag::ellint_1_, Site> dispatching_ellint_1_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::ellint_1_, Site>();
   }
   template<class... Args>
   struct impl_ellint_1_;
  }
  /*!

...
namespace nt2 { namespace tag
   ...
   **/
    struct ellie_ : ext::elementwise_<ellie_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_ellie_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
   template<class Site, class... Ts>
   BOOST_FORCEINLINE generic_dispatcher<tag::ellie_, Site> dispatching_ellie_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::ellie_, Site>();
   }
   template<class... Args>
   struct impl_ellie_;
  }

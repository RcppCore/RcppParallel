...
namespace nt2 { namespace tag
   ...
   **/
    struct perms_ : ext::unspecified_<perms_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_perms_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
   template<class Site, class... Ts>
   BOOST_FORCEINLINE generic_dispatcher<tag::perms_, Site> dispatching_perms_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::perms_, Site>();
   }
   template<class... Args>
   struct impl_perms_;
  }

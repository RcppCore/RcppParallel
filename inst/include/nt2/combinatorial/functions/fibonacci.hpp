...
namespace nt2 { namespace tag
   ...
   **/
    struct fibonacci_ : ext::unspecified_<fibonacci_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_fibonacci_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
   template<class Site, class... Ts>
   BOOST_FORCEINLINE generic_dispatcher<tag::fibonacci_, Site> dispatching_fibonacci_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::fibonacci_, Site>();
   }
   template<class... Args>
   struct impl_fibonacci_;
  }
  /*!

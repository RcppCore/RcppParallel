...
namespace nt2 { namespace tag
   ...
   **/
    struct rat_ : ext::elementwise_<rat_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_rat_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
   template<class Site, class... Ts>
   BOOST_FORCEINLINE generic_dispatcher<tag::rat_, Site> dispatching_rat_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::rat_, Site>();
   }
   template<class... Args>
   struct impl_rat_;
  }

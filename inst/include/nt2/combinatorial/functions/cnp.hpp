...
namespace nt2 { namespace tag
   ...
   **/
    struct cnp_ : ext::elementwise_<cnp_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_cnp_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
   template<class Site, class... Ts>
   BOOST_FORCEINLINE generic_dispatcher<tag::cnp_, Site> dispatching_cnp_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::cnp_, Site>();
   }
   template<class... Args>
   struct impl_cnp_;
  }

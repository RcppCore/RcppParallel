...
namespace nt2 { namespace tag
   ...
   **/
    struct gcd_ : ext::elementwise_<gcd_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_gcd_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
   template<class Site, class... Ts>
   BOOST_FORCEINLINE generic_dispatcher<tag::gcd_, Site> dispatching_gcd_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::gcd_, Site>();
   }
   template<class... Args>
   struct impl_gcd_;
  }

...
namespace nt2
{
   ...
   **/
    struct permsn_ : ext::unspecified_<permsn_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_permsn_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
   template<class Site, class... Ts>
   BOOST_FORCEINLINE generic_dispatcher<tag::permsn_, Site> dispatching_permsn_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::permsn_, Site>();
   }
   template<class... Args>
   struct impl_permsn_;
  }

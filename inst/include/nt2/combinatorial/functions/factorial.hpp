...
namespace nt2 { namespace tag
   ...
   **/
    struct factorial_ : ext::elementwise_<factorial_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_factorial_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
   template<class Site, class... Ts>
   BOOST_FORCEINLINE generic_dispatcher<tag::factorial_, Site> dispatching_factorial_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
   {
     return generic_dispatcher<tag::factorial_, Site>();
   }
   template<class... Args>
   struct impl_factorial_;
  }
  /*!

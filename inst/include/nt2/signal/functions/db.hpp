  ...
  namespace tag
  {
    ...
    **/
    struct db_ : ext::elementwise_<db_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_db_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
    template<class Site, class... Ts>
    BOOST_FORCEINLINE generic_dispatcher<tag::db_, Site> dispatching_db_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
    {
      return generic_dispatcher<tag::db_, Site>();
    }
    template<class... Args>
    struct impl_db_;
  }

  ...
  namespace tag
  {
    ...
    **/
    struct unwrap_ : ext::unspecified_<unwrap_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_unwrap_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
    template<class Site, class... Ts>
    BOOST_FORCEINLINE generic_dispatcher<tag::unwrap_, Site> dispatching_unwrap_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<Ts>...)
    {
      return generic_dispatcher<tag::unwrap_, Site>();
    }
    template<class... Args>
    struct impl_unwrap_;
  }

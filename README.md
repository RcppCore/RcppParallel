...
Here are links to some examples that illustrate using RcppParallel. Performance benchmarks were executed on a Haswell MacBook Pro with 4 cores (8 with hyperthreading). 

---
title: 'R, Rcpp and Parallel Computing: Notes from our Rcpp Experience'
...
- linebreak in title?
- multiline date: to give conference title and location?
- equivalent of framesubtitle ?
- highlight URLs (say in blue) as we can with latex?
- format included chart more finely: centering, size, ...
...
![Tweet](images/big-data-big-machine-tweet.png)
